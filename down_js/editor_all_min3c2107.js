...
for(var n,i=0;n=e[i++];){
try{
this.options.debug&&c.isArray(this.eventLog)&&this.eventLog.push({
time:+new Date,
name:n,
...
if(this.options.debug&&c.isArray(this.eventLog)){
var u=this.eventLog.length,f=this.eventLog[u-1];
...
tabindex:"tabIndex",
readonly:"readOnly"
},h=c.listToMap(["inline","inline-block","inline-table"]);
styleBlock=c.listToMap(["-webkit-box","-moz-box","block","list-item","table","table-row-group","table-header-group","table-footer-group","table-row","table-column-group","table-column","table-cell","table-caption"]);
var p=l&&"6"==s.version?"﻿":"​",g=l&&"6"==s.version?"&#65279;":"&#8203;",v=a.domUtils={
NODE_ELEMENT:1,
NODE_DOCUMENT:9,
NODE_TEXT:3,
NODE_COMMENT:8,
...
inDoc:function(e,t){
return 10==v.getPosition(e,t);
},
findParent:function(e,t,n){
if(e&&!v.isBody(e))for(e=n?e:e.parentNode;e;){
if(!t||t(e)||v.isBody(e))return t&&!t(e)&&v.isBody(e)?null:e;
e=e.parentNode;
}
return null;
},
findPreviousSibling:function(e,t,n){
if(e&&!v.isBody(e))for(e=n?e:e.previousSibling;e;){
if(!t||t(e)||v.isBody(e))return t&&!t(e)&&v.isBody(e)?null:e;
e=e.previousSibling;
}
return null;
...
if(e&&!v.isBody(e))for(e=n?e:e.nextSibling;e;){
if(!t||t(e)||v.isBody(e))return t&&!t(e)&&v.isBody(e)?null:e;
e=e.nextSibling;
}
return null;
...
return t=c.listToMap(c.isArray(t)?t:[t]),v.findParent(e,function(e){
return t[e.tagName]&&!(i&&i(e));
},n);
},
findParents:function(e,t,n,i){
for(var o=t&&(n&&n(e)||!n)?[e]:[];e=v.findParent(e,n);)o.push(e);
...
function i(e,t){
for(var n;e&&!v.isBookmarkNode(e)&&(v.isEmptyInlineElement(e)||!new RegExp("[^	\n\r"+v.fillChar+"]").test(e.nodeValue));)n=e[t],
v.remove(e),e=n;
}
...
return v.insertAfter(e,i);
}
var o=e.splitText(t);
if(s.ie8){
var r=n.createTextNode("");
v.insertAfter(o,r),v.remove(r);
}
return o;
},
isWhitespace:function(e){
return!new RegExp("[^ 	\n\r"+v.fillChar+"]").test(e.nodeValue);
},
getXY:function(e){
...
on:function(e,t,n){
var i=c.isArray(t)?t:c.trim(t).split(/\s+/),o=i.length;
...
if("style"==o.nodeName){
if(o.specified&&a++,v.isSameStyle(e,t))continue;
return!1;
}
if(l){
...
return e?1==e.nodeType&&(f.$block[e.tagName]||styleBlock[v.getComputedStyle(e,"display")])&&!f.$nonChild[e.tagName]:!1;
},
isBlockElm2:function(e){
if(e&&1==e.nodeType){
var t=v.getComputedStyle(e,"display");
return f.$block2[e.tagName]&&!h[t]||styleBlock[t]?!0:!1;
}
return!1;
},
isBody:function(e){
...
if(v.isBookmarkNode(e))return 0;
if(1==e.nodeType&&!v.isEmptyInlineElement(e)||3==e.nodeType&&!v.isWhitespace(e))return 0;
e=e.nextSibling;
}
return 1;
},
...
function t(t){
for(var n;(n=e[t])&&3==n.nodeType&&v.isWhitespace(n);)e.removeChild(n);
}
t("firstChild"),t("lastChild");
},
mergeChild:function(e,t,n){
for(var i,o=v.getElementsByTagName(e,e.tagName.toLowerCase()),r=0;i=o[r++];)if(i.parentNode&&!v.isBookmarkNode(i))if("span"!=i.tagName.toLowerCase())v.isSameElement(e,i)&&v.remove(i,!0);else{
if(e===i.parentNode&&(v.trimWhiteTextNode(e),1==e.childNodes.length)){
e.style.cssText=i.style.cssText+";"+e.style.cssText,v.remove(i,!0);
continue;
}
...
v.isSameStyle(i,e)&&v.remove(i,!0);
}
},
...
if(v.trimWhiteTextNode(t),"SPAN"==t.tagName&&!v.isSameStyle(t,e)||"A"==t.tagName&&"SPAN"==e.tagName){
...
function i(e,t,n){
var i;
if((i=n[e])&&!v.isBookmarkNode(i)&&1==i.nodeType&&v.isSameElement(n,i)){
...
return v.setAttributes(e.createElement(t),n);
},
...
try{
var r=v.getStyle(e,t)||(window.getComputedStyle?v.getWindow(e).getComputedStyle(e,"").getPropertyValue(t):(e.currentStyle||e.style)[c.cssStyleToDomStyle(t)]);
}catch(a){
return"";
}
...
o=c.trim(o).replace(/[ ]{2,}/g," "),o?e.className=o:v.removeAttributes(e,["class"]);
},
...
e.style.cssText||v.removeAttributes(e,["style"]);
},
...
for(var n in t)t.hasOwnProperty(n)&&v.setStyle(e,n,t[n]);
},
...
return!e.firstChild||0==v.getChildCount(e,function(e){
return!v.isBr(e)&&!v.isBookmarkNode(e)&&!v.isWhitespace(e);
});
},
clearSelectedArr:function(e){
for(var t;t=e.pop();)v.removeAttributes(t,["class"]);
},
...
return 3==e.nodeType&&!e.nodeValue.replace(new RegExp((t?"^":"")+v.fillChar),"").length;
},
...
for(var r=o.previousSibling;r&&v.isFillChar(r);)o=r,r=r.previousSibling;
}
for(this.isFillChar(o,!0)&&1==n.startOffset&&(n.setStartBefore(o),o=n.startContainer);o&&v.isFillChar(o);)t=o,
o=o.previousSibling;
for(t&&(n.setStartBefore(t),o=n.startContainer),1==o.nodeType&&v.isEmptyNode(o)&&1==n.startOffset&&n.setStart(o,0).collapse(!0);!n.startOffset;){
if(o=n.startContainer,v.isBlockElm(o)||v.isBody(o)){
i=1;
break;
}
var a,r=n.startContainer.previousSibling;
if(r){
for(;r&&v.isFillChar(r);)a=r,r=r.previousSibling;
n.setStartBefore(a?a:n.startContainer);
}else n.setStartBefore(n.startContainer);
}
return i&&!v.isBody(n.startContainer)?1:0;
},
isEmptyBlock:function(e,t){
if(!e)return 0;
if(1!=e.nodeType)return 0;
if(t=t||new RegExp("[ 	\r\n"+v.fillChar+"]","g"),e[s.ie?"innerText":"textContent"].replace(t,"").length>0)return 0;
...
var n=s.ie?e.createTextNode(v.fillChar):e.createElement("br");
...
for(var n;!v.isBody(e);)if(n=e,e=e.parentNode,n!==e[t])return!1;
return!0;
},
fillHtml:s.ie11below?p:"<br/>"
},b=v.fillCharReg;
!function(){
function e(e){
...
if(!n)return o;
try{
1==n.nodeType&&(f.$empty[n.tagName]||f.$nonChild[n.tagName])&&(i=v.getNodeIndex(n)+(t?0:1),
...
for(var c,u,f=d,m=v.findParents(o,!0),h=v.findParents(r,!0),p=0;m[p]==h[p];)p++;
for(var g,b=p;g=m[b];b++){
...
f.appendChild(u));c&&c!==r&&c!==h[b];)g=c.nextSibling,f.appendChild(t?c:c.cloneNode(!0)),
c=g;
f=u;
}
f=d,m[p]||(f.appendChild(m[p-1].cloneNode(!1)),f=f.firstChild);
for(var y,b=p;y=h[b];b++){
if(c=y.previousSibling,y==r?i||3!=e.endContainer.nodeType||(f.appendChild(l.createTextNode(r.substringData(0,s))),
t&&r.deleteData(0,s)):(u=y.cloneNode(!1),f.appendChild(u)),b!=p||!m[p])for(;c&&c!==o;)y=c.previousSibling,
f.insertBefore(t?c:c.cloneNode(!0),f.firstChild),c=y;
f=u;
}
return t&&e.setStartBefore(h[p]?m[p]?h[p]:m[p-1]:h[p-1]).collapse(!0),n&&v.remove(n),
i&&v.remove(i),d;
}
function o(e,t){
try{
if(l&&v.inDoc(l,e))if(l.nodeValue.replace(b,"").length)l.nodeValue=l.nodeValue.replace(b,"");else{
var n=l.parentNode;
for(v.remove(l);n&&v.isEmptyInlineElement(n)&&(s.safari?!(v.getPosition(n,t)&v.POSITION_CONTAINS):!n.contains(t));)l=n.parentNode,
v.remove(n),n=l;
}
}catch(i){}
}
function r(e,t){
var n;
for(e=e[t];e&&v.isFillChar(e);)n=e[t],v.remove(e),e=n;
}
var l,d=0,u=v.fillChar,m=a.Range=function(e){
var t=this;
...
return this.setStart(e.parentNode,v.getNodeIndex(e)+1);
},
setStartBefore:function(e){
return this.setStart(e.parentNode,v.getNodeIndex(e));
},
setEndAfter:function(e){
return this.setEnd(e.parentNode,v.getNodeIndex(e)+1);
},
setEndBefore:function(e){
return this.setEnd(e.parentNode,v.getNodeIndex(e));
},
...
function t(e){
return 1==e.nodeType&&!v.isBookmarkNode(e)&&!f.$empty[e.tagName]&&!f.$nonChild[e.tagName];
}
...
return o===r?e&&t(this)&&(o=o.childNodes[i.startOffset],1==o.nodeType)?o:n&&3==o.nodeType?o.parentNode:o:v.getCommonAncestor(o,r);
},
...
return e||(n=this.endOffset,o=this.endContainer,3==o.nodeType&&(0==n?this.setEndBefore(o):(n<o.nodeValue.length&&v.split(o,n),
...
return this.setStartBefore(t),v.remove(t),n?(this.setEndBefore(n),v.remove(n)):this.collapse(!0),
this;
},
enlarge:function(e,t){
var n,i,o=v.isBody,r=this.document.createTextNode("");
if(e){
for(i=this.startContainer,1==i.nodeType?i.childNodes[this.startOffset]?n=i=i.childNodes[this.startOffset]:(i.appendChild(r),
n=i=r):n=i;;){
if(v.isBlockElm(i)){
for(i=n;(n=i.previousSibling)&&!v.isBlockElm(n);)i=n;
...
n=i=r):n=i;;){
if(v.isBlockElm(i)){
for(i=n;(n=i.nextSibling)&&!v.isBlockElm(n);)i=n;
this.setEndAfter(i);
break;
}
n=i,i=i.parentNode;
}
r.parentNode===this.endContainer&&this.endOffset--,v.remove(r);
}
if(!this.collapsed){
...
if(!this.collapsed){
for(;!v.isBody(this.startContainer)&&this.startOffset==this.startContainer[3==this.startContainer.nodeType?"nodeValue":"childNodes"].length&&this.startContainer[3==this.startContainer.nodeType?"nodeValue":"childNodes"].length;)this.setStartAfter(this.startContainer);
for(;!v.isBody(this.endContainer)&&!this.endOffset&&this.endContainer[3==this.endContainer.nodeType?"nodeValue":"childNodes"].length;)this.setEndBefore(this.endContainer);
}
return this;
},
...
return 1==e.nodeType&&v.isBlockElm(e);
}).adjustmentBoundary();
for(var i,o,r=this.createBookmark(),a=r.end,s=function(e){
return 1==e.nodeType?"br"!=e.tagName.toLowerCase():!v.isWhitespace(e);
},l=v.getNextDomNode(r.start,!1,s),d=this.cloneRange();l&&v.getPosition(l,a)&v.POSITION_PRECEDING;)if(3==l.nodeType||f[e]&&f[e][l.tagName]){
for(d.setStartBefore(l),i=l;i&&(3==i.nodeType||f[e]&&f[e][i.tagName])&&i!==a;)o=i,
i=v.getNextDomNode(i,1==i.nodeType,null,function(t){
...
var m,h;
h=m=n[0].cloneNode(!1);
for(var p,g=1;p=n[g++];)m.appendChild(p.cloneNode(!1)),m=m.firstChild;
c=m;
}else c=d.document.createElement(e);
t&&v.setAttributes(c,t),c.appendChild(u),d.insertNode(n?h:c);
var b;
if("span"==e&&t.style&&/text\-decoration/.test(t.style)&&(b=v.findParentByTagName(c,"a",!0))?(v.setAttributes(b,t),
v.remove(c,!0),c=b):(v.mergeSibling(c),v.clearEmptySibling(c)),v.mergeChild(c,t),
l=v.getNextDomNode(c,!1,s),v.mergeToParent(c),i===a)break;
}else l=v.getNextDomNode(l,!0,s);
...
o.insertNode(i),v.clearEmptySibling(t,!0),t.parentNode.insertBefore(r.start,t)),
n&&(o=this.cloneRange().setStartAfter(r.end).setEndAfter(n),i=o.extractContents(),
o.insertNode(i),v.clearEmptySibling(n,!1,!0),n.parentNode.insertBefore(r.end,n.nextSibling));
for(var a,s=v.getNextDomNode(r.start,!1,function(e){
return 1==e.nodeType;
});s&&s!==r.end;)a=v.getNextDomNode(s,!0,function(e){
return 1==e.nodeType;
}),c.indexOf(e,s.tagName.toLowerCase())>-1&&v.remove(s,!0),s=a;
return this.moveToBookmark(r);
},
...
var f=this.document.createTextNode(u),m=this.document.createElement("span");
m.appendChild(this.document.createTextNode(u)),c.parentNode.insertBefore(m,c),c.parentNode.insertBefore(f,c),
o(this.document,f),l=f,r(m,"previousSibling"),r(c,"nextSibling"),n.moveStart("character",-1),
n.collapse(!0);
}
}else{
...
this.moveToBookmark(d),m&&v.remove(m);
try{
n.select();
}catch(a){}
return this;
...
var n,i=v.getWindow(this.document),a=i.getSelection();
if(s.gecko?this.document.body.focus():i.focus(),a){
if(a.removeAllRanges(),!this.startContainer)return;
if(this.collapsed&&!e){
...
if(c){
for(;c&&v.isBlockElm(c)&&1==c.nodeType&&c.childNodes[0];)c=c.childNodes[0];
c&&this.setStartBefore(c).collapse(!0);
}else c=this.startContainer.lastChild,c&&v.isBr(c)&&this.setStartBefore(c).collapse(!0);
}
if(t(this),!v.isBody(this.startContainer)){
...
e=e?window:v.getWindow(this.document);
var n=this,i=n.document.createElement("span");
return i.innerHTML="&nbsp;",n.cloneRange().insertNode(i),v.scrollToView(i,e,t),v.remove(i),
n;
},
inFillChar:function(){
var e=this.startContainer;
return this.collapsed&&3==e.nodeType&&e.nodeValue.replace(new RegExp("^"+v.fillChar),"").length+1==e.nodeValue.length?!0:!1;
},
createDomAddress:function(e,t){
function n(e){
for(var t,n=v.findParents(e,!0,function(e){
return!v.isBody(e);
...
function n(e){
for(var n,i=e?o.startContainer:o.endContainer,r=v.findParents(i,!0,function(e){
return!v.isBody(e);
}),a=[],s=0;n=r[s++];)a.push(v.getNodeIndex(n,t));
var l=0;
if(t)if(3==i.nodeType){
for(var d=i.previousSibling;d&&3==d.nodeType;)l+=d.nodeValue.replace(b,"").length,
d=d.previousSibling;
l+=e?o.startOffset:o.endOffset;
}else if(i=i.childNodes[e?o.startOffset:o.endOffset])l=v.getNodeIndex(i,t);else{
i=e?o.startContainer:o.endContainer;
for(var c=i.firstChild;c;)if(v.isFillChar(c))c=c.nextSibling;else if(l++,3==c.nodeType)for(;c&&3==c.nodeType;)c=c.nextSibling;else c=c.nextSibling;
}else l=e?v.isFillChar(i)?0:o.startOffset:o.endOffset;
...
if(this.collapsed)return this;
for(var n=this.createBookmark(),i=n.end,o=v.getNextDomNode(n.start,!1,t);o&&o!==i&&v.getPosition(o,i)&v.POSITION_PRECEDING;){
var r=v.getNextDomNode(o,!1,t);
e(o),o=r;
}
...
var t,i=this;
i.document=e,s.ie9below&&(t=v.getWindow(e).frameElement,v.on(t,"beforedeactivate",function(){
i._bakIERange=i.getIERange();
}),v.on(t,"activate",function(){
try{
...
return n===this.document.body||v.inDoc(n,this.document);
},
getNative:function(){
var e=this.document;
try{
return e?s.ie9below?e.selection:v.getWindow(e).getSelection():null;
}catch(t){
return null;
}
},
...
var e=this.getStart();
return e?v.findParents(e,!0,null,!0):[];
},
clear:function(){
...
i.setStart(d.startContainer,d.startOffset).setEnd(c.endContainer,c.endOffset),i.collapsed&&v.isBody(i.startContainer)&&!i.startOffset&&e(i);
}else{
if(this._bakRange&&v.inDoc(this._bakRange.startContainer,this.document))return this._bakRange;
e(i);
}
}
...
for(var i,o=0,r=v.getElementsByTagName(e,"textarea");i=r[o++];)if(i.id=="ueditor_textarea_"+t.options.textarea){
n=i;
break;
}
}else n=t.textarea;
n||(e.appendChild(n=v.createElement(document,"textarea",{
...
var o,r=0,d=UE.Editor=function(e){
var i=this;
i.uid=r++,u.call(i),i.commands={},i.options=c.clone(e||{}),i.shortcutkeys={},i.inputRules=[],
i.outputRules=[],i.inputNativeNodeRules=[],c.isEmptyObject(UE.I18N)?t(i):(i.options.lang=n(UE.I18N),
...
n.value=e.getContent(),n.id=e.key,t.innerHTML="",v.remove(t);
var i=e.key;
...
e.appendChild(v.createElement(document,"iframe",{
id:"ueditor_"+t.uid,
...
for(var r=this.iframe.parentNode;!v.isBody(r);r=r.parentNode)if("FORM"==r.tagName){
n.form=r,n.options.autoSyncData?v.on(n.window,"blur",function(){
e(r,n);
}):v.on(r,"submit",function(){
e(this,n);
});
break;
}
...
v.isEmptyNode(n.body)&&(n.body.innerHTML="<p>"+(s.ie11below?v.fillChar:"<br/>")+"</p>"),
...
s.ie9below||v.on(n.window,["blur","focus"],function(e){
if("blur"==e.type){
...
sync:function(t){
var n=this,i=t?document.getElementById(t):v.findParent(n.iframe.parentNode,function(e){
...
var u=UE.htmlparser(s,i);
return a.filterOutputRule(u),a.fireEvent("aftergetcontent",e),u.toHtml(o);
}
return"";
},
getAllHtml:function(){
...
var e=new RegExp(v.fillChar,"g"),t=this.body.innerHTML.replace(/[\n\r]/g,"");
return t=t.replace(/<(p|div)[^>]*>(<br\/?>|&nbsp;)<\/\1>/gi,"\n").replace(/<br\/?>/gi,"\n").replace(/<[^>\/]+>/g,"").replace(/(\n)?<\/([^>]+)>/g,function(e,t,n){
return f.$block[n]?"\n":t?t:"";
}),t.replace(e,"").replace(/\u00a0/g," ").replace(/&nbsp;/g," ");
},
getContentTxt:function(){
var e=new RegExp(v.fillChar,"g");
...
if(!d||1==d.nodeType&&(f.$cdata[d.tagName]||o(d)||v.isCustomeNode(d))&&d===this.body.lastChild)this.body.innerHTML="<p>"+(s.ie11below?v.fillChar:"<br/>")+"</p>"+this.body.innerHTML;else for(var c=r.document.createElement("p");d;){
...
e._proxyDomEvent=c.bind(e._proxyDomEvent,e),v.on(t,["click","contextmenu","mousedown","keydown","keyup","keypress","mouseup","mouseover","mouseout","selectstart"],e._proxyDomEvent),
v.on(n,["focus","blur"],e._proxyDomEvent),v.on(t,["mouseup","keydown"],function(t){
...
l.collapsed||(a=!0,n=t.clientX,i=t.clientY);
}
...
for(e=["div"],n=0;t=e[n++];)for(var i,o=v.getElementsByTagName(this.document,t),r=0;i=o[r++];)if(v.isCustomeNode(i))return!0;
return!1;
},
reset:function(){
...
function e(){
var t=this;
t.document.getElementById("initContent")&&(t.body.innerHTML="<p>"+(s.ie11below?v.fillChar:"<br/>")+"</p>",
...
t(o,a)),i.children&&i.children.length)for(var u,m=0;u=i.children[m++];)r&&"element"==u.type&&!f.$inlineWithA[u.tagName]&&m>1&&(e(o,a),
t(o,a)),n(u,o,r,a);
...
toHtml:function(e){
var t=[];
return n(this,t,e,0),t.join("").replace(new RegExp(v.fillChar,"g"),"");
},
...
e=e.replace(new RegExp(v.fillChar,"g"),""),t||(e=e.replace(new RegExp("[\\r\\t\\n"+(t?"":" ")+"]*</?(\\w+)\\s*(?:[^>]*)>[\\r\\t\\n"+(t?"":" ")+"]*","g"),function(e,n){
...
h=l.index;
try{
if(h>p&&n(b,e.slice(p,h)),l[3])b=i(b,l[3].toLowerCase(),l[4]);else if(l[1]){
if("root"!=b.type){
for(var y=b;"element"==b.type&&b.tagName!=l[1].toLowerCase();)if(b=b.parentNode,
"root"==b.type)throw b=y,"break";
b=b.parentNode;
}
}else l[2]&&o(b,l[2]);
}catch(C){}
...
return p<e.length&&n(b,e.slice(p)),g;
...
t.getAttr("data-fillchar")&&0==t.innerHTML().replace(v.fillCharReg,"").length&&(s.ie11below?t.appendChild(UE.uNode.createFillChar()):(t.parentNode.insertBefore(UE.uNode.createElement("br"),t),
t.parentNode.removeChild(t)));
break;

case"p":
(n=t.getAttr("align"))&&(t.setAttr("align"),t.setStyle("text-align",n)),t.firstChild()?1==t.children.length&&"br"==t.children[0].tagName&&s.ie11below&&(t.removeChild(t.children[0]),
t.appendChild(UE.uNode.createFillChar())):s.ie11below?t.appendChild(UE.uNode.createFillChar()):t.innerHTML("<br />");
break;
...
if(s.ie11below)for(var n=function(e){
return v.isBody(e)||3==e.nodeType&&0==(e.nodeValue||"").replace(v.fillCharReg,"").length?!1:!0;
},i=t.getElementsByTagName("br"),o=0;o<i.length;o++){
var r=i[o];
if(r.parentNode){
var a,l=v.findPreviousSibling(r,n,!1),d=!1,c=v.findNextSibling(r,n,!1),u=!1;
if(!l)for(l=r;l&&(l=v.findParent(l,null,!1));){
if(/^(td|li)$/i.test(l.nodeName)){
l=null;
break;
}
if(a=v.findPreviousSibling(l,n,!1)){
l=a;
break;
}
}
d=!l||v.isBlockElm2(l)?!0:!1;
var a;
if(!c)for(c=r;c&&(c=v.findParent(c,null,!1));){
if(/^(td|li)$/i.test(c.nodeName)){
c=null;
break;
}
if(a=v.findNextSibling(c,n,!1)){
c=a;
break;
}
}
if(u=!c||v.isBlockElm2(c)?!0:!1,u===!1);else if(d===!1)r.parentNode.removeChild(r),
o-=1;else if(d===!0){
var f=e.document.createElement("div");
f.innerHTML='<span data-fillchar="1">'+v.fillChar+"</span>",r.parentNode.insertBefore(f.children[0],r),
...
case"span":
s.ie11below&&t.getAttr("data-fillchar")&&0==t.innerHTML().replace(v.fillCharReg,"").length&&(t.parentNode.insertBefore(UE.uNode.createElement("br"),t),
t.parentNode.removeChild(t));
}
}
});
...
if(v.isFillChar(d)&&i.setStartBefore(d),d=i.endContainer,v.isFillChar(d)&&i.setEndAfter(d),
i.txtToElmBoundary(),i.endContainer&&1==i.endContainer.nodeType&&(d=i.endContainer.childNodes[i.endOffset],
d&&v.isBr(d)&&i.setEndAfter(d)),0==i.startOffset&&(d=i.startContainer,v.isBoundaryNode(d,"firstChild")&&(d=i.endContainer,
i.endOffset==(3==d.nodeType?d.nodeValue.length:d.childNodes.length)&&v.isBoundaryNode(d,"lastChild")&&(r.body.innerHTML="<p>"+(s.ie11below?v.fillChar:"<br/>")+"</p>",
...
if(m&&v.isBlockElm2(m)&&(u=m.previousSibling)&&v.isBlockElm2(u)){
...
var m,h,u,p,g,y=0;
i.inFillChar()&&(m=i.startContainer,v.isFillChar(m)?(i.setStartBefore(m).collapse(!0),
v.remove(m)):v.isFillChar(m,!0)&&(m.nodeValue=m.nodeValue.replace(b,""),i.startOffset--,
i.collapsed&&i.collapse(!0)));
var C=v.findParentByTagName(i.startContainer,"li",!0);
if(C){
for(var N,x;m=o.firstChild;){
for(;m&&(3==m.nodeType||!v.isBlockElm2(m)||"HR"==m.tagName);)N=m.nextSibling,i.insertNode(m).collapse(),
l.push(m),x=m,m=N;
if(m)if(/^(ol|ul)$/i.test(m.tagName)){
for(;m.firstChild;)x=m.firstChild,v.insertAfter(C,m.firstChild),l.push(x),C=C.nextSibling;
v.remove(m);
}else{
var w;
N=m.nextSibling,w=r.document.createElement("li"),v.insertAfter(C,w),w.appendChild(m),
x=m,l.push(x),m=N,C=w;
}
}
C=v.findParentByTagName(i.startContainer,"li",!0),v.isEmptyBlock(C)&&v.remove(C),
x&&i.setStartAfter(x).collapse(!0).select(!0);
}else{
for(;m=o.firstChild;){
if(y){
for(var E=r.document.createElement("p");m&&(3==m.nodeType||!f.$block2[m.tagName]);)g=m.nextSibling,
E.appendChild(m),m=g;
E.firstChild&&(m=E);
}
if(i.insertNode(m),l.push(m),g=m.nextSibling,!y&&m.nodeType==v.NODE_ELEMENT&&v.isBlockElm2(m)&&(h=v.findParent(m,function(e){
return v.isBlockElm2(e);
}),h&&"body"!=h.nodeName.toLowerCase()&&(!f[h.nodeName]||!f[h.nodeName][m.nodeName]||m.parentNode!==h))){
if(f[h.nodeName]&&f[h.nodeName][m.nodeName])for(p=m.parentNode;p&&p!==h;)u=p,p=p.parentNode;else u=h;
v.breakParent(m,u||p);
var u=m.previousSibling;
v.trimWhiteTextNode(u),u.childNodes.length||v.remove(u),!s.ie&&(N=m.nextSibling)&&v.isBlockElm2(N)&&N.lastChild&&!v.isBr(N.lastChild)&&N.appendChild(r.document.createElement("br")),
y=1;
}
var N=m.nextSibling;
if(!o.firstChild&&N&&v.isBlockElm2(N)){
i.setStart(N,0).collapse(!0);
break;
}
i.setEndAfter(m).collapse();
}
if(m=i.startContainer,g&&v.isBr(g)&&v.remove(g),v.isBlockElm2(m)&&v.isEmptyNode(m))if(g=m.nextSibling)v.remove(m),
1==g.nodeType&&f.$block2[g.tagName]&&i.setStart(g,0).collapse(!0).shrinkBoundary();else try{
m.innerHTML=s.ie11below?v.fillChar:"<br/>";
}catch(T){
i.setStartBefore(m),v.remove(m);
}
try{
i.select(!0);
}catch(T){}
...
i=r.selection.getRange(),i.scrollToView(r.autoHeightEnabled,r.autoHeightEnabled?v.getXY(r.iframe).y-200:0),
r.fireEvent("afterinserthtml","",l);
},200),l;
}
}
...
var e=this,t=v.findParentByTagName(e.iframe,"form",!1);
if(t){
...
if(r=l,"P"==r.tagName&&"center"==v.getStyle(r,"text-align")){
if(!v.isBody(r)&&1==v.getChildCount(r,function(e){
return!v.isBr(e)&&!v.isWhitespace(e);
}))if(a=r.previousSibling,s=r.nextSibling,a&&s&&1==a.nodeType&&1==s.nodeType&&a.tagName==s.tagName&&v.isBlockElm(a)){
for(a.appendChild(r.firstChild);s.firstChild;)a.appendChild(s.firstChild);
v.remove(r),v.remove(s);
}else v.setStyle(r,"text-align","");
i.selectNode(o).select();
}
v.setStyle(o,"float","none"==t?"":t),"none"==t&&v.removeAttributes(o,"align");
break;

case"center":
if("center"!=n.queryCommandValue("imagefloat")){
for(l=o.parentNode,v.setStyle(o,"float",""),v.removeAttributes(o,"align"),r=o;l&&1==v.getChildCount(l,function(e){
return!v.isBr(e)&&!v.isWhitespace(e);
...
v.setStyle(r,"float",""),n.execCommand("insertHtml",'<p id="_img_parent_tmp" style="text-align:center">'+l.innerHTML+"</p>"),
...
return n.collapsed?"none":(e=n.getClosedNode(),e&&1==e.nodeType&&"IMG"==e.tagName?(t=e.getAttribute("align")||v.getComputedStyle(e,"float"),
"none"==t&&(t="center"==v.getComputedStyle(e.parentNode,"text-align")?"center":t),
{
left:1,
right:1,
center:1
...
return 1==e.nodeType?"br"!=e.tagName.toLowerCase()&&!v.isBookmarkNode(e):!v.isWhitespace(e);
};
t.enlarge(!0);
for(var r,a=t.createBookmark(),s=v.getNextDomNode(a.start,!1,o),l=t.cloneRange();s&&!(v.getPosition(s,a.end)&v.POSITION_FOLLOWING);)if(3!=s.nodeType&&e(s))s=v.getNextDomNode(s,!0,o);else{
for(l.setStartBefore(s);s&&s!==a.end&&!e(s);)r=s,s=v.getNextDomNode(s,!1,null,function(t){
return!e(t);
});
l.setEndAfter(r);
var d=l.getCommonAncestor();
if(!v.isBody(d)&&e(d))v.setStyles(d,c.isString(n)?{
"text-align":n
}:n),s=d;else{
var u=t.document.createElement("p");
v.setStyles(u,c.isString(n)?{
"text-align":n
}:n);
var f=l.extractContents();
u.appendChild(f),l.insertNode(u),s=u;
}
s=v.getNextDomNode(s,!1,o);
}
...
i&&(o.setStartBefore(i).collapse(!0),v.remove(i)),o.select(),!0;
},
queryCommandValue:function(){
var e=this.selection.getStart(),n=v.getComputedStyle(e,"text-align");
return t[n]?n:"left";
},
queryCommandState:function(){
var e=this.selection.getStart(),t=e&&v.findParentByTagName(e,["td","th","caption"],!0);
return t?-1:0;
}
};
},UE.plugins.font=function(){
function e(e){
for(var t;(t=e.parentNode)&&"SPAN"==t.tagName&&1==v.getChildCount(t,function(e){
return!v.isBookmarkNode(e)&&!v.isBr(e);
});)t.style.cssText+=e.style.cssText,v.remove(e,!0),e=t;
}
function t(e,t,n){
if(a[t]&&(e.adjustmentBoundary(),!e.collapsed&&1==e.startContainer.nodeType)){
var i=e.startContainer.childNodes[e.startOffset];
if(i&&v.isTagNode(i,"span")){
var o=e.createBookmark();
c.each(v.getElementsByTagName(i,"span"),function(e){
e.parentNode&&!v.isBookmarkNode(e)&&("backcolor"!=t||v.getComputedStyle(e,"background-color").toLowerCase()!==n)&&(v.removeStyle(e,a[t]),
0==e.style.cssText.replace(/^\s+$/,"").length&&v.remove(e,!0));
}),e.moveToBookmark(o);
}
}
}
...
if(a)for(r=l.start.parentNode;f.$inline[r.tagName];)r=r.parentNode;else r=v.getCommonAncestor(l.start,l.end);
c.each(v.getElementsByTagName(r,"span"),function(t){
if(t.parentNode&&!v.isBookmarkNode(t)){
if(/\s*border\s*:\s*none;?\s*/i.test(t.style.cssText))return void(/^\s*border\s*:\s*none;?\s*$/.test(t.style.cssText)?v.remove(t,!0):v.removeStyle(t,"border"));
...
"fontborder"!=i||"none"!=o)for(var n=t.nextSibling;n&&1==n.nodeType&&"SPAN"==n.tagName;)if(v.isBookmarkNode(n)&&"fontborder"==i)t.appendChild(n),
n=t.nextSibling;else{
if(n.style.cssText==t.style.cssText&&(v.moveChild(n,t),v.remove(n)),t.nextSibling===n)break;
n=t.nextSibling;
}
if(e(t),s.ie&&s.version>8){
var r=v.findParent(t,function(e){
...
var a,l=this,c=this.selection.getRange(),u=l.fireEvent("getCommonReportIDKey",[i,o+""]);
if(u){
l.fireEvent("reportAddNum",u.id,u.key,1);
var f=l.fireEvent("getCommonReportIDKey",[i,"all"]);
f&&l.fireEvent("reportAddNum",f.id,f.key,1);
}
if("default"==o)c.collapsed&&(a=l.document.createTextNode("font"),c.insertNode(a).select()),
l.execCommand("removeFormat","span,a",t),a&&(c.setStartBefore(a).collapse(!0),v.remove(a)),
n(c,i,o),c.select();else if(c.collapsed){
var m=v.findParentByTagName(c.startContainer,"span",!0);
if(a=l.document.createTextNode("font"),!m||m.children.length||m[s.ie?"innerText":"textContent"].replace(b,"").length){
if(c.insertNode(a),c.selectNode(a).select(),m=c.document.createElement("span"),r[e]){
if(v.findParentByTagName(a,"a",!0))return c.setStartBefore(a).setCursor(),void v.remove(a);
l.execCommand("removeFormat","span,a",t);
}
if(m.style.cssText=t+":"+o,a.parentNode.insertBefore(m,a),!s.ie||s.ie&&9==s.version)for(var h=m.parentNode;!v.isBlockElm(h);)"SPAN"==h.tagName&&(m.style.cssText=h.style.cssText+";"+m.style.cssText),
h=h.parentNode;
d?setTimeout(function(){
c.setStart(m,0).collapse(!0),n(c,i,o),c.select();
}):(c.setStart(m,0).collapse(!0),n(c,i,o),c.select());
}else c.insertNode(a),r[e]&&(c.selectNode(a).select(),l.execCommand("removeFormat","span,a",t,null),
m=v.findParentByTagName(a,"span",!0),c.setStartBefore(a)),m&&(m.style.cssText+=";"+t+":"+o),
c.collapse(!0).select();
v.remove(a);
}else r[e]&&(l.queryCommandValue(e)||"backcolor"==e)&&l.execCommand("removeFormat","span,a",t),
c=l.selection.getRange(),c.applyInlineStyle("span",{
style:t+":"+o
}),n(c,i,o),c.select();
return!0;
},
...
for(var i,o=n;o&&!v.isBlockElm(o)&&!v.isBody(o);){
if(1==o.nodeType&&(i=v.getComputedStyle(o,t),"none"!=i))return i;
o=o.parentNode;
}
return"none";
}
...
if((r=v.getComputedStyle(a,"border"))&&/1px/.test(r)&&/solid/.test(r))return r;
a=a.parentNode;
}
return"";
}
if("FontSize"==e){
var s=v.getComputedStyle(n,t),a=/^([\d\.]+)(\w+)$/.exec(s);
return a?Math.floor(a[1])+a[2]:s;
}
return v.getComputedStyle(n,t);
},
...
var i=v.findParentByTagName(e.startContainer,"a",!0);
i&&e.setStartBefore(i),i=v.findParentByTagName(e.endContainer,"a",!0),i&&e.setEndAfter(i);
}
for(d=e.createBookmark(),g=d.start;(c=g.parentNode)&&!v.isBlockElm(c);)v.breakParent(g,c),
v.clearEmptySibling(g);
if(d.end){
for(g=d.end;(c=g.parentNode)&&!v.isBlockElm(c);)v.breakParent(g,c),v.clearEmptySibling(g);
for(var a,s=v.getNextDomNode(d.start,!1,p);s&&s!=d.end;)a=v.getNextDomNode(s,!0,p),
f.$empty[s.tagName.toLowerCase()]||v.isBookmarkNode(s)||(u.test(s.tagName)?n?(v.removeStyle(s,n),
r(s)&&"text-decoration"!=n&&v.remove(s,!0)):v.remove(s,!0):f.$tableContent[s.tagName]||f.$list[s.tagName]||(v.removeAttributes(s,m),
r(s)&&v.remove(s,!0))),s=a;
}
var l=d.start.parentNode;
!v.isBlockElm(l)||f.$tableContent[l.tagName]||f.$list[l.tagName]||v.removeAttributes(l,m),
l=d.end.parentNode,d.end&&v.isBlockElm(l)&&!f.$tableContent[l.tagName]&&!f.$list[l.tagName]&&v.removeAttributes(l,m),
e.moveToBookmark(d).moveToBookmark(t);
for(var h,g=e.startContainer,b=e.collapsed;1==g.nodeType&&v.isEmptyNode(g)&&f.$removeEmpty[g.tagName];)h=g.parentNode,
e.setStartBefore(g),e.startContainer===e.endContainer&&e.endOffset--,v.remove(g),
g=h;
if(!b)for(g=e.endContainer;1==g.nodeType&&v.isEmptyNode(g)&&f.$removeEmpty[g.tagName];)h=g.parentNode,
e.setEndBefore(g),v.remove(g),g=h;
}
var d,c,u=new RegExp("^(?:"+(t||this.options.removeFormatTags).replace(/,/g,"|")+")$","i"),m=n?[]:(i||this.options.removeFormatAttributes).split(","),h=new a.Range(this.document),p=function(e){
return 1==e.nodeType;
};
...
function e(e){
return v.filterNodeList(e.selection.getStartElementPath(),"blockquote");
}
var t=this;
...
if(o){
var s=i.startContainer,l=v.isBlockElm(s)?s:v.findParent(s,function(e){
return v.isBlockElm(e);
}),d=i.endContainer,c=v.isBlockElm(d)?d:v.findParent(d,function(e){
return v.isBlockElm(e);
});
l=v.findParentByTagName(l,"li",!0)||l,c=v.findParentByTagName(c,"li",!0)||c,"LI"==l.tagName||"TD"==l.tagName||l===o||v.isBody(l)?v.remove(o,!0):v.breakParent(l,o),
l!==c&&(o=v.findParentByTagName(c,"blockquote"),o&&("LI"==c.tagName||"TD"==c.tagName||v.isBody(c)?o.parentNode&&v.remove(o,!0):v.breakParent(c,o)));
for(var u,m=v.getElementsByTagName(this.document,"blockquote"),h=0;u=m[h++];)u.childNodes.length?v.getPosition(u,l)&v.POSITION_FOLLOWING&&v.getPosition(u,c)&v.POSITION_PRECEDING&&v.remove(u,!0):v.remove(u);
}else{
for(var p=i.cloneRange(),g=1==p.startContainer.nodeType?p.startContainer:p.startContainer.parentNode,b=g,y=1;;){
if(v.isBody(g)){
b!==g?i.collapsed?(p.selectNode(b),y=0):p.setStartBefore(b):p.setStart(g,0);
break;
}
if(!r[g.tagName]){
i.collapsed?(p.selectNode(b),y=0):p.setStartBefore(b);
break;
}
b=g,g=g.parentNode;
}
if(y)for(b=g=g=1==p.endContainer.nodeType?p.endContainer:p.endContainer.parentNode;;){
if(v.isBody(g)){
b!==g?p.setEndAfter(b):p.setEnd(g,g.childNodes.length);
break;
}
if(!r[g.tagName]){
p.setEndAfter(b);
...
g=i.document.createElement("blockquote"),v.setAttributes(g,n),g.appendChild(p.extractContents()),
p.insertNode(g);
for(var C,N=v.getElementsByTagName(g,"blockquote"),h=0;C=N[h++];)C.parentNode&&v.remove(C,!0);
}
...
queryCommandState:function(){
var e=v.filterNodeList(this.selection.getStartElementPath(),"p h1 h2 h3 h4 h5 h6");
...
n.selectNodeContents(t),v.isEmptyBlock(t)&&(s.opera&&t.firstChild&&1==t.firstChild.nodeType&&n.setStartAtFirst(t.firstChild),
...
var e=this,t=v.isBlockElm,n=["TD","LI","PRE"],i=function(e,i,o,r){
var a,s=e.createBookmark(),l=function(e){
return 1==e.nodeType?"br"!=e.tagName.toLowerCase()&&!v.isBookmarkNode(e):!v.isWhitespace(e);
};
e.enlarge(!0);
for(var d,u=e.createBookmark(),f=v.getNextDomNode(u.start,!1,l),m=e.cloneRange();f&&!(v.getPosition(f,u.end)&v.POSITION_FOLLOWING);)if(f&&"justifyindent"==r&&/^(li)|(ol)|(ul)$/i.test(f.nodeName))"li"==f.nodeName.toLowerCase()&&(f=v.findParent(f,function(e){
return e&&/^(ol)|(ul)$/i.test(e.nodeName)?!0:void 0;
})),v.setAttributes(f,o),f=v.getNextDomNode(f,!1,l);else if(3!=f.nodeType&&t(f))f=v.getNextDomNode(f,!0,l);else{
for(m.setStartBefore(f);f&&f!==u.end&&!t(f);)d=f,f=v.getNextDomNode(f,!1,null,function(e){
return!t(e);
});
m.setEndAfter(d),a=e.document.createElement(i),o&&(v.setAttributes(a,o),r&&"customstyle"==r&&o.style&&(a.style.cssText=o.style)),
a.appendChild(m.extractContents()),v.isEmptyNode(a)&&v.fillChar(e.document,a),m.insertNode(a);
var h=a.parentNode;
t(h)&&!v.isBody(a.parentNode)&&-1==c.indexOf(n,h.tagName)&&(r&&"customstyle"==r||(h.getAttribute("dir")&&a.setAttribute("dir",h.getAttribute("dir")),
...
h.style.padding&&!a.style.padding&&(a.style.padding=h.style.padding)),o&&/h\d/i.test(h.tagName)&&!/h\d/i.test(a.tagName)?(v.setAttributes(h,o),
r&&"customstyle"==r&&o.style&&(h.style.cssText=o.style),v.remove(a,!0),a=h):v.remove(a.parentNode,!0)),
f=-1!=c.indexOf(n,h.tagName)?h:a,f=v.getNextDomNode(f,!1,l);
}
...
l&&v.isWhitespace(l)&&v.remove(l),l=a.nextSibling,l&&v.isWhitespace(l)&&v.remove(l);
}
}
if(r=i(r,t,n,o),a&&(r.setStartBefore(a).collapse(!0),pN=a.parentNode,v.remove(a),
v.isBlockElm(pN)&&v.isEmptyNode(pN)&&v.fillNode(this.document,pN)),s.gecko&&r.collapsed&&1==r.startContainer.nodeType){
...
queryCommandState:function(){
return v.filterNodeList(this.selection.getStartElementPath(),"table")?-1:0;
}
},e.addListener("delkeydown",function(e,t){
var n=this.selection.getRange();
if(n.txtToElmBoundary(!0),v.isStartInblock(n)){
var i=n.startContainer,o=i.previousSibling;
if(o&&v.isTagNode(o,"hr"))return v.remove(o),n.select(),v.preventDefault(t),!0;
}
});
...
var n,i=v.filterNodeList(this.selection.getStartElementPath(),function(e){
return v.isBlockElm(e);
});
return i?(n=v.getComputedStyle(i,"margin-"+t).replace(/[^\d]/g,""),n?n:0):0;
}
};
...
queryCommandValue:function(){
var e,t=v.findParents(this.selection.getStart(),!0,function(e){
return/^(ol)|(ul)$/i.test(e.nodeName)?!0:void 0;
},!0);
if(e=t&&t.length>0?t[0]:v.filterNodeList(this.selection.getStartElementPath(),function(e){
return v.isBlockElm(e);
})){
var n=v.getComputedStyle(e,"margin-left").replace(/[^\d]/g,""),i=v.getComputedStyle(e,"margin-right").replace(/[^\d]/g,"");
return n&&n==i?n:0;
}
return 0;
}
...
queryCommandValue:function(){
var e=v.filterNodeList(this.selection.getStartElementPath(),function(e){
return v.isBlockElm(e);
});
if(e){
var t=v.getComputedStyle(e,"line-height");
...
execCommand:function(e,t){
var n=this,i=n.selection.getRange(),o=v.findParentByTagName(i.startContainer,"pre",!0);
if(o)o.className="brush:"+t+";toolbar:false;";else{
var r="";
if(i.collapsed)r=s.ie&&s.ie11below?s.version<=8?"&nbsp;":"":"<br/>";else{
var a=i.extractContents(),l=n.document.createElement("div");
...
}),/br>$/.test(r)||(r+="<br>")):r+=e.data+"<br>",!e.nextSibling()&&/<br>$/.test(r)&&(r=r.replace(/<br>$/,""));else if(r+="element"==e.type?f.$empty[e.tagName]?"":e.innerText():e.data,
!/br\/?\s*>$/.test(r)){
...
o=n.document.getElementById("coder"),v.removeAttributes(o,"id");
var d=o.previousSibling;
d&&(3==d.nodeType&&1==d.nodeValue.length&&s.ie&&6==s.version||v.isEmptyBlock(d))&&v.remove(d);
var i=n.selection.getRange();
v.isEmptyBlock(o)?i.setStart(o,0).setCursor(!1,!0):i.selectNodeContents(o).select();
}
},
queryCommandValue:function(){
...
var t=e.selection.getRange(),n=v.findParentByTagName(t.startContainer,"pre",!0);
if(n){
...
t.insertNode(l),t.insertNode(e.document.createTextNode(v.fillChar)),t.setStartAfter(l),
n=l.previousSibling;
...
if(n){
for(var c="";n&&"BR"!=n.nodeName&&new RegExp("^[ "+v.fillChar+"]*$").test(n.nodeValue);)c+=n.nodeValue,
n=n.nextSibling;
if("BR"!=n.nodeName){
var u=n.nodeValue.match(new RegExp("^([ "+v.fillChar+"]+)"));
u&&u[1]&&(c+=u[1]);
}
...
if(n){
for(var c="";n&&"BR"!=n.nodeName&&new RegExp("^[\\s"+v.fillChar+"]*$").test(n.nodeValue);)c+=n.nodeValue,
n=n.nextSibling;
if(n&&n.nodeValue&&n.nodeName&&"BR"!=n.nodeName){
var u=n.nodeValue.match(new RegExp("^([\\s"+v.fillChar+"]+)"));
u&&u[1]&&(c+=u[1]);
}
...
var i=e.selection.getRange(),o=v.findParentByTagName(i.startContainer,"pre",!0);
if(o){
...
{
var e=this,t=e.selection.getRange();
v.findParentByTagName(t.startContainer,"pre",!0);
}
}),e.addListener("keydown",function(e,t){
var n=this,i=t.keyCode||t.which;
if(40==i){
var o,r=n.selection.getRange(),a=r.startContainer;
if(r.collapsed&&(o=v.findParentByTagName(r.startContainer,"pre",!0))&&!o.nextSibling){
...
if(v.isTagNode(o,"pre")&&i.collapsed&&v.isStartInblock(i)){
var r=e.document.createElement("p");
return v.fillNode(e.document,r),o.parentNode.insertBefore(r,o),v.remove(o),i.setStart(r,0).setCursor(!1,!0),
...
"br"==t?(e.body.innerHTML="<br/>",n.setStart(e.body,0).setCursor()):(e.body.innerHTML="<p>"+(s.ie11below?v.fillChar:"<br/>")+"</p>",
...
var e=this;
e.ready(function(){
v.on(this.body,"dragend",function(){
var t=e.selection.getRange(),n=t.getClosedNode()||e.selection.getStart();
if(n&&"IMG"==n.tagName){
for(var i,o=n.previousSibling;(i=n.nextSibling)&&1==i.nodeType&&"SPAN"==i.tagName&&!i.firstChild;)v.remove(i);
(!o||1!=o.nodeType||v.isEmptyBlock(o))&&o||i&&(!i||v.isEmptyBlock(i))||(o&&"P"==o.tagName&&!v.isEmptyBlock(o)?(o.appendChild(n),
v.moveChild(i,o),v.remove(i)):i&&"P"==i.tagName&&!v.isEmptyBlock(i)&&i.insertBefore(n,i.firstChild),
o&&"P"==o.tagName&&v.isEmptyBlock(o)&&v.remove(o),i&&"P"==i.tagName&&v.isEmptyBlock(i)&&v.remove(i),
...
function n(){
var e=r.editor.ui.buttons.undo,t=r.editor.ui.buttons.redo,n=d.queryCommandState("undo"),i=d.queryCommandState("redo");
...
e.document.body.innerHTML=n.toHtml(),e.fireEvent("afterscencerestore"),s.ie&&c.each(v.getElementsByTagName(e.document,"td th caption p"),function(t){
v.isEmptyNode(t)&&v.fillNode(e.document,t);
});
try{
...
this.list.push(i),this.list.length>u&&this.list.shift(),this.index=this.list.length-1,
...
var l,d=this,u=d.options.maxUndoCount||20,f=d.options.maxInputCount||20,m=new RegExp(v.fillChar+"|</hr>","gi"),h={
ol:1,
ul:1,
table:1,
tbody:1,
...
v.on(this.body,"compositionstart",function(){
C=!0;
}),v.on(this.body,"compositionend",function(){
C=!1;
});
}),d.addshortcutkey({
Undo:"ctrl+90",
...
if(!(b[o]||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey)){
if(C)return;
if(!i.selection.getRange().collapsed)return i.undoManger.save(!1,!0),void(N=!1);
0==i.undoManger.list.length&&i.undoManger.save(!0),clearTimeout(l),l=setTimeout(function(){
...
if(!(b[n]||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey)){
if(C)return;
...
o.id="baidu_pastebin",s.webkit&&o.appendChild(t.createTextNode(v.fillChar+v.fillChar)),
t.body.appendChild(o),i.start.style.display="",o.style.cssText="position:absolute;width:1px;height:1px;overflow:hidden;left:-1000px;white-space:nowrap;top:"+v.getXY(i.start).y+"px",
...
var t,a;
if(e.firstChild){
for(var l,d=v.getElementsByTagName(e,"span"),u=0;l=d[u++];)("_baidu_cut_start"==l.id||"_baidu_cut_end"==l.id)&&v.remove(l);
if(s.webkit){
for(var f,m=e.querySelectorAll("div br"),u=0;f=m[u++];){
var h=f.parentNode;
"DIV"==h.tagName&&1==h.childNodes.length&&(h.innerHTML="<p><br/></p>",v.remove(h));
}
for(var p,g=e.querySelectorAll("#baidu_pastebin"),u=0;p=g[u++];){
var b=r.document.createElement("p");
for(p.parentNode.insertBefore(b,p);p.firstChild;)b.appendChild(p.firstChild);
v.remove(p);
}
for(var y,C=e.querySelectorAll("meta"),u=0;y=C[u++];)v.remove(y);
var m=e.querySelectorAll("br");
for(u=0;y=m[u++];)/^apple-/i.test(y.className)&&v.remove(y);
}
if(s.gecko){
var N=e.querySelectorAll("[_moz_dirty]");
for(u=0;y=N[u++];)y.removeAttribute("_moz_dirty");
}
if(!s.ie)for(var y,x=e.querySelectorAll("span.Apple-style-span"),u=0;y=x[u++];)v.remove(y,!0);
r.filterInputNativeNode(e),t=e.innerHTML,t=UE.filterWord(t),t=t.replace(/(<[^>]+?style=([\'\"]))([^\2]*?text-decoration-line[\s]*:[^\2]*?)(\2)/gi,function(){
...
l&&3==l.nodeType&&new RegExp("^[\n\r	 "+v.fillChar+"]*$").test(l.nodeValue)&&a.setStartBefore(l);
}
if(0!=a.startOffset)break;
a.setStartBefore(a.startContainer);
}
for(;!v.isBody(a.endContainer);){
...
var u=d.nextSibling;
u&&3==u.nodeType&&new RegExp("^[\n\r	"+v.fillChar+"]*$").test(u.nodeValue)&&a.setEndAfter(u);
}
...
for(var m=r.selection.getRange();!v.isBody(m.startContainer)&&!m.startOffset&&m.startContainer[3==m.startContainer.nodeType?"nodeValue":"childNodes"].length;)m.setStartBefore(m.startContainer);
var h=m.createAddress(!0);
o.endAddress=h.startAddress;
}
}),r.addListener("ready",function(){
v.on(r.body,"cut",function(){
var e=r.selection.getRange();
!e.collapsed&&r.undoManger&&r.undoManger.save();
});
var n="onpaste"in r.document;
v.on(r.body,n?"paste":"keydown",function(i){
return(n||(i.ctrlKey||i.metaKey)&&"86"==i.keyCode)&&r.fireEvent("beforepasteEvent")!==!1?r.fireEvent("onpasting",i)===!0?(i.stopPropagation&&(i.stopPropagation(),
...
function t(e){
var t=e.className;
return v.hasClass(e,/custom_/)?t.match(/custom_(\w+)/)[1]:v.getStyle(e,"list-style-type");
}
function n(e,n){
c.each(v.getElementsByTagName(e,"ol ul"),function(r){
if(v.inDoc(r,e)){
var a=r.parentNode;
...
var f=0,h=2;
v.hasClass(r,/custom_/)?/[ou]l/i.test(a.tagName)&&v.hasClass(a,/custom_/)||(h=1):/[ou]l/i.test(a.tagName)&&v.hasClass(a,/custom_/)&&(h=3);
var p=v.getStyle(r,"list-style-type"),g=v.getStyle(r,"margin-left"),b=v.getStyle(r,"margin-right"),y="";
p&&(y+="list-style-type:"+p+";"),g&&(y+="margin-left:"+g+";"),b&&(y+="margin-right:"+b+";"),
r.style.cssText=y,r.className=c.trim(r.className.replace(/list-paddingleft-\w+/,""))+" list-paddingleft-"+h,
c.each(v.getElementsByTagName(r,"li"),function(e){
if(e.style.cssText&&(e.style.cssText=""),!e.firstChild)return void v.remove(e);
if(e.parentNode===r){
if(f++,v.hasClass(r,/custom_/)){
var n=1,i=t(r);
if("OL"==r.tagName){
if(i)switch(i){
case"cn":
...
null===o||o.replace(/\s/g,"")||v.removeAttributes(e,"class");
}
}),!n&&i(r,r.tagName.toLowerCase(),t(r)||v.getStyle(r,"list-style-type"),!0);
}
});
}
function i(e,i,o,r){
var a=e.nextSibling;
a&&1==a.nodeType&&a.tagName.toLowerCase()==i&&(t(a)||v.getStyle(a,"list-style-type")||("ol"==i?"decimal":"disc"))==o&&(v.moveChild(a,e),
0==a.childNodes.length&&v.remove(a)),a&&v.isFillChar(a)&&v.remove(a);
var s=e.previousSibling;
s&&1==s.nodeType&&s.tagName.toLowerCase()==i&&(t(s)||v.getStyle(s,"list-style-type")||("ol"==i?"decimal":"disc"))==o&&v.moveChild(e,s),
s&&v.isFillChar(s)&&v.remove(s),!r&&v.isEmptyBlock(e)&&v.remove(e),t(e)&&n(e.ownerDocument,!0);
}
function o(e,t){
u[t]&&(e.className="custom_"+t);
try{
v.setStyle(e,"list-style-type",t);
}catch(n){}
}
function r(e){
var t=e.previousSibling;
t&&v.isEmptyBlock(t)&&v.remove(t),t=e.nextSibling,t&&v.isEmptyBlock(t)&&v.remove(t);
}
function a(e){
for(;e&&!v.isBody(e);){
...
for(var p in u)l.options.insertorderedlist.hasOwnProperty(p)||l.options.insertunorderedlist.hasOwnProperty(p)||delete u[p];
l.ready(function(){
var e=[];
for(var t in u){
if("dash"==t||"dot"==t)e.push("li.list-"+u[t]+"{background-image:url("+h+u[t]+".gif)}"),
...
v.on(l.body,"cut",function(){
setTimeout(function(){
var e,t=l.selection.getRange();
if(!t.collapsed&&(e=v.findParentByTagName(t.startContainer,"li",!0))&&!e.nextSibling&&v.isEmptyBlock(e)){
var n,i=e.parentNode;
if(n=i.previousSibling)v.remove(i),t.setStartAtLast(n).collapse(!0),t.select(!0);else if(n=i.nextSibling)v.remove(i),
t.setStartAtFirst(n).collapse(!0),t.select(!0);else{
var o=l.document.createElement("p");
v.fillNode(l.document,o),i.parentNode.insertBefore(o,i),v.remove(i),t.setStart(o,0).collapse(!0),
t.select(!0);
}
}
});
...
if(i=v.findParentByTagName(r.startContainer,"li",!0)){
...
(n.firstChild()&&!n.parentNode||!e.firstChild())&&e.appendChild(n),n.firstChild()||n.innerHTML(s.ie11below?v.fillChar:"<br/>");
...
if(13==o&&!t.shiftKey){
var a=l.selection.getRange(),s=v.findParent(a.startContainer,function(e){
return v.isBlockElm(e);
},!0),d=v.findParentByTagName(a.startContainer,"li",!0);
if(s&&"PRE"!=s.tagName&&!d){
var c=s.innerHTML.replace(new RegExp(v.fillChar,"g"),"");
...
var u=l.selection.getRange(),m=i(u.startContainer,function(e){
...
if(m&&h&&m===h){
if(!u.collapsed){
if(m=v.findParentByTagName(u.startContainer,"li",!0),h=v.findParentByTagName(u.endContainer,"li",!0),
!m||!h||m!==h){
var p=u.cloneRange(),g=p.collapse(!1).createBookmark();
u.deleteContents(),p.moveToBookmark(g);
var d=v.findParentByTagName(p.startContainer,"li",!0);
return r(d),p.select(),void n();
}
if(u.deleteContents(),d=v.findParentByTagName(u.startContainer,"li",!0),d&&v.isEmptyBlock(d))return w=d.previousSibling,
next=d.nextSibling,C=l.document.createElement("p"),v.fillNode(l.document,C),b=d.parentNode,
w&&next?(u.setStart(next,0).collapse(!0).select(!0),v.remove(d)):((w||next)&&w?d.parentNode.parentNode.insertBefore(C,b.nextSibling):b.parentNode.insertBefore(C,b),
v.remove(d),b.firstChild||v.remove(b),u.setStart(C,0).setCursor()),void n();
}
if(d=v.findParentByTagName(u.startContainer,"li",!0)){
if(v.isEmptyBlock(d)){
g=u.createBookmark();
var b=d.parentNode;
if(d!==b.lastChild?(v.breakParent(d,b),r(d)):(b.parentNode.insertBefore(d,b.nextSibling),
v.isEmptyNode(b)&&v.remove(b)),!f.$list[d.parentNode.tagName])if(v.isBlockElm(d.firstChild))v.remove(d,!0);else{
...
for(!d.firstChild&&v.fillNode(l.document,C);d.firstChild;)C.appendChild(d.firstChild);
d.appendChild(C),y=C;
}
var N=l.document.createElement("span");
u.insertNode(N),v.breakParent(N,d);
var x=N.nextSibling;
y=x.firstChild,y||(C=l.document.createElement("p"),v.fillNode(l.document,C),x.appendChild(C),
y=C),v.isEmptyNode(y)&&(y.innerHTML="",v.fillNode(l.document,y)),u.setStart(y,0).collapse(!0).shrinkBoundary().select(),
v.remove(N);
var w=x.previousSibling;
w&&v.isEmptyBlock(w)&&(w.innerHTML="<p></p>",v.fillNode(l.document,w.firstChild));
}
n();
}
}
}
if(8==o&&(u=l.selection.getRange(),u.collapsed&&v.isStartInblock(u)&&(p=u.cloneRange().trimBoundary(),
d=v.findParentByTagName(u.startContainer,"li",!0),d&&v.isStartInblock(p)))){
if(m=v.findParentByTagName(u.startContainer,"p",!0),m&&m!==d.firstChild){
var b=v.findParentByTagName(m,["ol","ul"]);
return v.breakParent(m,b),r(m),l.fireEvent("contentchange"),u.setStart(m,0).setCursor(!1,!0),
l.fireEvent("saveScene"),void v.preventDefault(t);
}
if(d&&(w=d.previousSibling)){
if(46==o&&d.childNodes.length)return;
if(f.$list[w.tagName]&&(w=w.lastChild),l.undoManger&&l.undoManger.save(),y=d.firstChild,
v.isBlockElm(y))if(v.isEmptyNode(y))for(w.appendChild(y),u.setStart(y,0).setCursor(!1,!0);d.firstChild;)w.appendChild(d.firstChild);else N=l.document.createElement("span"),
u.insertNode(N),v.isEmptyBlock(w)&&(w.innerHTML=""),v.moveChild(d,w),u.setStartBefore(N).collapse(!0).select(!0),
v.remove(N);else if(v.isEmptyNode(d)){
var C=l.document.createElement("p");
...
return v.remove(d),l.fireEvent("contentchange"),l.fireEvent("saveScene"),void v.preventDefault(t);
}
if(d&&!d.previousSibling){
var b=d.parentNode,g=u.createBookmark();
if(v.isTagNode(b.parentNode,"ol ul"))b.parentNode.insertBefore(d,b),v.isEmptyNode(b)&&v.remove(b);else{
for(;d.firstChild;)b.parentNode.insertBefore(d.firstChild,b);
v.remove(d),v.isEmptyNode(b)&&v.remove(b);
}
return u.moveToBookmark(g).setCursor(!1,!0),l.fireEvent("contentchange"),l.fireEvent("saveScene"),
void v.preventDefault(t);
}
}
...
(r=v.findParentByTagName(a.startContainer,["ol","ul"],!0))&&i(r,r.tagName.toLowerCase(),t(r)||v.getComputedStyle(r,"list-style-type"),!0);
}
...
var n=l.selection.getRange(),r=v.findParentByTagName(n.startContainer,"li",!0);
if(r){
var a;
if(!n.collapsed){
l.fireEvent("saveScene"),a=n.createBookmark();
for(var s,d,u=0,f=v.findParents(r);d=f[u++];)if(v.isTagNode(d,"ol ul")){
s=d;
break;
}
var h=r;
if(a.end)for(;h&&!(v.getPosition(h,a.end)&v.POSITION_FOLLOWING);)if(e(h))h=v.getNextDomNode(h,!1,null,function(e){
return e!==s;
});else{
var p=h.parentNode,g=l.document.createElement(p.tagName),b=c.indexOf(m[g.tagName],t(p)||v.getComputedStyle(p,"list-style-type")),y=b+1==m[g.tagName].length?0:b+1,C=m[g.tagName][y];
for(o(g,C),p.insertBefore(g,h);h&&!(v.getPosition(h,a.end)&v.POSITION_FOLLOWING);){
if(r=h.nextSibling,g.appendChild(h),!r||v.isTagNode(r,"ol ul")){
if(r)for(;(r=r.firstChild)&&"LI"!=r.tagName;);else r=v.getNextDomNode(h,!1,null,function(e){
return e!==s;
});
break;
}
...
if(e(r))return!0;
var p=r.parentNode,g=l.document.createElement(p.tagName),b=c.indexOf(m[g.tagName],t(p)||v.getComputedStyle(p,"list-style-type"));
b=b+1==m[g.tagName].length?0:b+1;
var C=m[g.tagName][b];
if(o(g,C),v.isStartInblock(n))return l.fireEvent("saveScene"),a=n.createBookmark(),
p.insertBefore(g,r),g.appendChild(r),i(g,g.tagName.toLowerCase(),C),l.fireEvent("contentchange"),
...
return 1==e.nodeType?"br"!=e.tagName.toLowerCase():!v.isWhitespace(e);
},u="insertorderedlist"==e.toLowerCase()?"ol":"ul",m=r.document.createDocumentFragment();
s.adjustmentBoundary().shrinkBoundary();
var h,p,g,b,y=s.createBookmark(!0),C=a(r.document.getElementById(y.start)),N=0,x=a(r.document.getElementById(y.end)),w=0;
if(C||x){
if(C&&(h=C.parentNode),y.end||(x=C),x&&(p=x.parentNode),h===p){
for(;C!==x;){
if(b=C,C=C.nextSibling,!v.isBlockElm(b.firstChild)){
for(var E=r.document.createElement("p");b.firstChild;)E.appendChild(b.firstChild);
b.appendChild(E);
}
m.appendChild(b);
}
if(b=r.document.createElement("span"),h.insertBefore(b,x),!v.isBlockElm(x.firstChild)){
for(E=r.document.createElement("p");x.firstChild;)E.appendChild(x.firstChild);
x.appendChild(E);
}
m.appendChild(x),v.breakParent(b,h),v.isEmptyNode(b.previousSibling)&&v.remove(b.previousSibling),
v.isEmptyNode(b.nextSibling)&&v.remove(b.nextSibling);
var T=t(h)||v.getComputedStyle(h,"list-style-type")||("insertorderedlist"==e.toLowerCase()?"decimal":"disc");
if(h.tagName.toLowerCase()==u&&T==n){
for(var S,k=0,B=r.document.createDocumentFragment();S=m.childNodes[k++];)if(v.isTagNode(S,"ol ul"))c.each(v.getElementsByTagName(S,"li"),function(e){
for(;e.firstChild;)B.appendChild(e.firstChild);
});else for(;S.firstChild;)B.appendChild(S.firstChild);
b.parentNode.insertBefore(B,b);
}else g=r.document.createElement(u),o(g,n),g.appendChild(m),b.parentNode.insertBefore(g,b);
return v.remove(b),g&&i(g,u,n),void s.moveToBookmark(y).select();
}
if(C){
for(;C;){
if(b=C.nextSibling,v.isTagNode(C,"ol ul"))m.appendChild(C);else{
for(var _=r.document.createDocumentFragment(),I=0;C.firstChild;)v.isBlockElm(C.firstChild)&&(I=1),
_.appendChild(C.firstChild);
if(I)m.appendChild(_);else{
...
h.parentNode.insertBefore(m,h.nextSibling),v.isEmptyNode(h)?(s.setStartBefore(h),
v.remove(h)):s.setStartAfter(h),N=1;
}
if(x&&v.inDoc(p,r.document)){
for(C=p.firstChild;C&&C!==x;){
if(b=C.nextSibling,v.isTagNode(C,"ol ul"))m.appendChild(C);else{
for(_=r.document.createDocumentFragment(),I=0;C.firstChild;)v.isBlockElm(C.firstChild)&&(I=1),
_.appendChild(C.firstChild);
I?m.appendChild(_):(R=r.document.createElement("p"),R.appendChild(_),m.appendChild(R)),
v.remove(C);
}
C=b;
}
var L=v.createElement(r.document,"div",{
tmpDiv:1
});
v.moveChild(x,L),m.appendChild(L),v.remove(x),p.parentNode.insertBefore(m,p),s.setEndBefore(p),
v.isEmptyNode(p)&&v.remove(p),w=1;
}
}
...
for(var A,D=s.createBookmark(),P=v.getNextDomNode(D.start,!1,l),M=s.cloneRange(),O=v.isBlockElm;P&&P!==D.end&&v.getPosition(P,D.end)&v.POSITION_PRECEDING;)if(3==P.nodeType||f.li[P.tagName]){
if(1==P.nodeType&&f.$list[P.tagName]){
for(;P.firstChild;)m.appendChild(P.firstChild);
A=v.getNextDomNode(P,!1,l),v.remove(P),P=A;
continue;
}
for(A=P,M.setStartBefore(P);P&&P!==D.end&&(!O(P)||v.isBookmarkNode(P));)A=P,P=v.getNextDomNode(P,!1,null,function(e){
return!d[e.tagName];
});
P&&O(P)&&(b=v.getNextDomNode(A,!1,l),b&&v.isBookmarkNode(b)&&(P=v.getNextDomNode(b,!1,l),
A=b)),M.setEndAfter(A),P=v.getNextDomNode(A,!1,l);
var U=s.document.createElement("li");
if(U.appendChild(M.extractContents()),v.isEmptyNode(U)){
for(var A=s.document.createElement("p");U.firstChild;)A.appendChild(U.firstChild);
U.appendChild(A);
}
m.appendChild(U);
}else P=v.getNextDomNode(P,!0,l);
s.moveToBookmark(D).collapse(!0),g=r.document.createElement(u),o(g,n),g.appendChild(m),
s.insertNode(g),i(g,u,n);
for(var S,k=0,H=v.getElementsByTagName(g,"div");S=H[k++];)S.getAttribute("tmpDiv")&&v.remove(S,!0);
...
return n?t(n)||v.getComputedStyle(n,"list-style-type"):null;
}
};
...
if(/h\d/i.test(e)){
if(s.gecko){
var d=v.findParentByTagName(l,["h1","h2","h3","h4","h5","h6","blockquote","caption","table"],!0);
d||(t.document.execCommand("formatBlock",!1,"<p>"),r=1);
}else if(1==l.nodeType){
var c,u=t.document.createTextNode("");
if(a.insertNode(u),c=v.findParentByTagName(u,"div",!0)){
for(var f=t.document.createElement("p");c.firstChild;)f.appendChild(c.firstChild);
c.parentNode.insertBefore(f,c),v.remove(c),a.setStartBefore(u).setCursor(),r=1;
}
v.remove(u);
}
...
if(13==r){
if(t.fireEvent("beforeenterkeydown"))return void v.preventDefault(o);
t.fireEvent("saveScene",!0,!0),e="";
var a=t.selection.getRange();
if(!a.collapsed){
var l=a.startContainer,d=a.endContainer,c=v.findParentByTagName(l,"td",!0),u=v.findParentByTagName(d,"td",!0);
if(c&&u&&c!==u||!c&&u||c&&!u)return void(o.preventDefault?o.preventDefault():o.returnValue=!1);
}
if("p"==n)s.ie||(l=v.findParentByTagName(a.startContainer,["ol","ul","p","h1","h2","h3","h4","h5","h6","blockquote","caption","section"],!0),
l||s.opera?(e=l.tagName,"p"==l.tagName.toLowerCase()&&s.gecko&&v.removeDirtyAttr(l)):(t.document.execCommand("formatBlock",!1,"<p>"),
s.gecko&&(a=t.selection.getRange(),l=v.findParentByTagName(a.startContainer,"p",!0),
l&&v.removeDirtyAttr(l))));else if(o.preventDefault?o.preventDefault():o.returnValue=!1,
a.collapsed){
h=a.document.createElement("br"),a.insertNode(h);
var m=h.parentNode;
m.lastChild===h?(h.parentNode.insertBefore(h.cloneNode(!0),h),a.setStartBefore(h)):a.setStartAfter(h),
a.setCursor();
...
return l.appendChild(h),a.setStart(l,0).setCursor(),t.undoManger&&t.undoManger.save(),
!1;
}
l=l.firstChild;
}
l===a.startContainer.childNodes[a.startOffset]?(h=a.document.createElement("br"),
a.insertNode(h).setCursor()):a.setStart(l,0).setCursor();
...
if(v.isFillChar(a)&&r.setStartBefore(a),a=r.endContainer,v.isFillChar(a)&&r.setEndAfter(a),
r.txtToElmBoundary(),r.endContainer&&1==r.endContainer.nodeType&&(a=r.endContainer.childNodes[r.endOffset],
a&&v.isBr(a)&&r.setEndAfter(a)),0==r.startOffset&&(a=r.startContainer,v.isBoundaryNode(a,"firstChild")&&(a=r.endContainer,
r.endOffset==(3==a.nodeType?a.nodeValue.length:a.childNodes.length)&&v.isBoundaryNode(a,"lastChild"))))return e.fireEvent("saveScene"),
e.body.innerHTML="<p>"+(s.ie11below?v.fillChar:"<br/>")+"</p>",r.setStart(e.body.firstChild,0).setCursor(!1,!0),
void e._selectionChange();
}
if(8==o){
if(r=e.selection.getRange(),t=r.collapsed,e.fireEvent("delkeydown",i))return;
var l,d;
if(r.collapsed&&r.inFillChar()&&(l=r.startContainer,v.isFillChar(l)?(r.setStartBefore(l).shrinkBoundary(!0).collapse(!0),
v.remove(l)):(l.nodeValue=l.nodeValue.replace(new RegExp("^"+v.fillChar),""),r.startOffset--,
r.collapse(!0).select(!0))),l=r.getClosedNode())return e.fireEvent("saveScene"),
r.setStartBefore(l),v.remove(l),r.setCursor(),e.fireEvent("saveScene"),void v.preventDefault(i);
if(!s.ie&&(l=v.findParentByTagName(r.startContainer,"table",!0),d=v.findParentByTagName(r.endContainer,"table",!0),
...
if(e.fireEvent("tabkeydown",i))return void v.preventDefault(i);
...
if(g.innerHTML=m+v.fillChar,u.collapsed)u.insertNode(g.cloneNode(!0).firstChild).setCursor(!0);else if(l=v.findParent(u.startContainer,y),
d=v.findParent(u.endContainer,y),l&&d&&l===d)u.deleteContents(),u.insertNode(g.cloneNode(!0).firstChild).setCursor(!0);else{
var b=u.createBookmark(),y=function(e){
return v.isBlockElm(e)&&!c[e.tagName.toLowerCase()];
};
u.enlarge(!0);
for(var C=u.createBookmark(),N=v.getNextDomNode(C.start,!1,y);N&&!(v.getPosition(N,C.end)&v.POSITION_FOLLOWING);)N.insertBefore(g.cloneNode(!0).firstChild,N.firstChild),
N=v.getNextDomNode(N,!1,y);
u.moveToBookmark(C).moveToBookmark(b).select();
}
v.preventDefault(i);
}
if(s.gecko&&46==o&&(u=e.selection.getRange(),u.collapsed&&(l=u.startContainer,v.isEmptyBlock(l)))){
for(var x=l.parentNode;1==v.getChildCount(x)&&!v.isBody(x);)l=x,x=x.parentNode;
...
if((a=v.findParentByTagName(i.startContainer,l,!0))&&v.isEmptyBlock(a)){
var d=a.previousSibling;
if(d&&"TABLE"!=d.nodeName)return v.remove(a),void i.setStartAtLast(d).setCursor(!1,!0);
var c=a.nextSibling;
if(c&&"TABLE"!=c.nodeName)return v.remove(a),void i.setStartAtFirst(c).setCursor(!1,!0);
}
if(v.isBody(i.startContainer)){
var a=v.createElement(r.document,"p",{
innerHTML:s.ie11below?v.fillChar:"<br/>"
});
i.insertNode(a).setStart(a,0).setCursor(!1,!0);
}
}
if(!t&&(3==i.startContainer.nodeType||1==i.startContainer.nodeType&&v.isEmptyBlock(i.startContainer)))if(s.ie){
var u=i.document.createElement("span");
i.insertNode(u).setStartBefore(u).collapse(!0),i.select(),v.remove(u);
}else i.select();
}
});
...
n&&1==n.nodeType&&(n.style.clear="both",i=Math.max(v.getXY(n).y+n.offsetHeight+25,a.minFrameHeight),
("adjustheight"==e||i!=r&&i!=$(t.iframe).height())&&(t.setHeight(i,!0),r=i),v.removeStyle(n,"clear"));
},50));
}
var t=this;
...
t.enableAutoHeight();
var n;
v.on(s.ie?t.body:t.document,s.webkit?"dragover":"drop",function(){
...
function n(){
var e=v.getXY(f),t=v.getComputedStyle(f,"position"),n=v.getComputedStyle(f,"left");
f.style.width=f.offsetWidth+"px",f.style.zIndex=1*r.options.zIndex+1,f.parentNode.insertBefore(y,f),
g||b&&s.ie?("absolute"!=f.style.position&&(f.style.position="absolute"),f.style.top=(document.body.scrollTop||document.documentElement.scrollTop)-m+d+"px"):(s.ie7Compat&&C&&(C=!1,
f.style.marginLeft="-45px",f.style.left=v.getXY(f).x-document.documentElement.getBoundingClientRect().left+2+"px"),
"fixed"!=f.style.position&&(f.style.position="fixed",f.style.top=d+"px",("absolute"==t||"relative"==t)&&parseFloat(n)&&(f.style.left=e.x+"px")));
}
function i(){
C=!0,y&&y.parentNode&&y.parentNode.removeChild(y),f&&(f.style.cssText=u,f.style.marginLeft="0px");
}
function o(){
if(h){
...
if(l){
var u,f,m,h,p=UE.ui.uiUtils,g=s.ie&&s.version<=6,b=s.quirks,y=document.createElement("div"),C=!0,N=c.defer(function(){
o();
},s.ie?200:100,!0);
r.addListener("destroy stop_toolbar_float",function(){
i(),v.un(window,["scroll","resize"],o),r.removeListener("keydown",N);
}),r.addListener("star_toolbar_float",function(){
r.fireEvent("stop_toolbar_float"),o(),v.on(window,["scroll","resize"],o),r.addListener("keydown",N);
}),r.addListener("ready",function(){
e(r)&&(h=p.getClientRect,f=r.ui.getDom("toolbarbox"),m=h(f).top,u=f.style.cssText,
y.style.height=f.offsetHeight+53+"px",g&&t(),v.on(window,["scroll","resize"],o),
...
c.each(e,function(e){
v.removeClasses(e,"selectTdClass");
});
},t.addSelectedClass=function(e){
c.each(e,function(e){
v.addClass(e,"selectTdClass");
});
},t.isEmptyBlock=function(e){
var t=new RegExp(v.fillChar,"g");
...
return e?parseInt(v.getComputedStyle(e,"width"),10):0;
...
var n=t&&v.findParentByTagName(t,["td","th"],!0),i=n&&n.parentNode,o=t&&v.findParentByTagName(t,"caption",!0),r=o?o.parentNode:i&&i.parentNode.parentNode;
return{
cell:n,
tr:i,
table:r,
...
if(t)return s=t.getElementsByTagName("td")[0],r=v.getComputedStyle(t,"border-left-width"),
n=parseInt(a[r]||r,10),r=v.getComputedStyle(s,"padding-left"),i=parseInt(a[r]||r,10),
r=v.getComputedStyle(s,"border-left-width"),o=parseInt(a[r]||r,10),{
tableBorder:n,
tdPadding:i,
tdBorder:o
};
...
return r=v.getComputedStyle(t,"border-left-width"),n=parseInt(a[r]||r,10),r=v.getComputedStyle(s,"padding-left"),
i=parseInt(a[r]||r,10),r=v.getComputedStyle(s,"border-left-width"),o=parseInt(a[r]||r,10),
v.remove(t),{
tableBorder:n,
tdPadding:i,
tdBorder:o
...
return e="td"==n||"th"==n||"caption"==n?v.findParentByTagName(e,"table",!0):e,e.ueTable||(e.ueTable=new t(e)),
e.ueTable;
},t.cloneCell=function(e,t,n){
if(!e||c.isString(e))return this.table.ownerDocument.createElement(e||"td");
var i=v.hasClass(e,"selectTdClass");
i&&v.removeClasses(e,"selectTdClass");
var o=e.cloneNode(!0);
return t&&(o.rowSpan=o.colSpan=1),!n&&v.removeAttributes(o,"width height"),!n&&v.removeAttributes(o,"style"),
...
o.style.borderTopWidth=e.style.borderBottomWidth,i&&v.addClass(e,"selectTdClass"),
o;
},t.prototype={
getMaxRows:function(){
...
try{
for(var i="x"===n.toLowerCase(),o=v.getXY(t)[i?"x":"y"]+t["offset"+(i?"Width":"Height")],r=this.table.rows,a=null,s=[],l=0;l<this.rowsNum;l++){
a=r[l].cells;
for(var d,c=0;d=a[c++];){
var u=v.getXY(d)[i?"x":"y"]+d["offset"+(i?"Width":"Height")];
if(u>o&&i)break;
...
e.innerHTML=t||(s.ie11below?v.fillChar:"<br />");
},
cloneCell:t.cloneCell,
getSameStartPosXCells:function(t){
try{
for(var n,i=v.getXY(t).x+t.offsetWidth,o=this.table.rows,r=[],a=0;a<this.rowsNum;a++){
n=o[a].cells;
for(var s,l=0;s=n[l++];){
var d=v.getXY(s).x;
if(d>i)break;
...
for(var m=u,h=d.rowSpan||1,p=d.colSpan||1;this.indexTable[l][m];)m++;
for(var g=0;h>g;g++)for(var b=0;p>b;b++)this.indexTable[l+g][m+b]={
rowIndex:l,
cellIndex:u,
colIndex:m,
rowSpan:h,
...
for(g=0;n>g;g++)for(b=0;o>b;b++)void 0===this.indexTable[g][b]&&(s=t[g],d=s.cells[s.cells.length-1],
d=d?d.cloneNode(!0):this.table.ownerDocument.createElement("td"),this.setCellContent(d),
1!==d.colSpan&&(d.colSpan=1),1!==d.rowSpan&&(d.rowSpan=1),s.appendChild(d),this.indexTable[g][b]={
rowIndex:g,
...
var y=v.getElementsByTagName(this.table,"td"),C=[];
if(c.each(y,function(e){
v.hasClass(e,"selectTdClass")&&C.push(e);
}),C.length){
...
var d,u=e+1,f=this.table.rows[u],m=this.getPreviewMergedCellsNum(u,r)-o;
r>m?(d=r-m-1,v.insertAfter(f.cells[d],l)):f.cells.length&&f.insertBefore(l,f.cells[0]),
o+=1;
}
r+=s.colSpan||1;
}
var h=[],p={};
for(r=0;i>r;r++){
var g=n[r].rowIndex,b=n[r].cellIndex,y=g+"_"+b;
p[y]||(p[y]=1,s=this.getCell(g,b),h.push(s));
}
var C=[];
c.each(h,function(e){
...
n.insertBefore(i,t),v.remove(t));
}else if("TH"==t.tagName){
var o=t.ownerDocument.createElement("td");
o.appendChild(t.firstChild),n.insertBefore(o,t),v.remove(t);
}
}
...
a&&r.setAttribute("width",a.getAttribute("width")),e?v.insertAfter(o.cells[o.cells.length-1],r):o.insertBefore(r,o.cells[0]),
...
var r=v.getElementsByTagName(this.table,"td");
c.each(r,function(t){
...
function t(e,t,n){
var i=e.body;
return i.offsetWidth-(t?2*parseInt(v.getComputedStyle(i,"margin-left"),10):0)-2*n.tableBorder-(e.options.offsetWidth||0);
}
function n(e){
var t=o(e).cell;
if(t){
...
n.push("<tr>");
for(var a=0;o>a;a++)n.push('<td width="'+t+'"  vAlign="'+e.tdvalign+'" >'+(s.ie11below?v.fillChar:"<br/>")+"</td>");
n.push("</tr>");
}
...
var i=this,o=this.selection.getRange(),r=o.startContainer,l=v.findParent(r,function(e){
return v.isBlockElm(e);
...
t.innerHTML=s.ie11below?v.fillChar:"<br />",e.parentNode.insertBefore(t,e),this.selection.getRange().setStart(t,0).setCursor();
}
}
},UE.commands.deletetable={
queryCommandState:function(){
var e=this.selection.getRange();
return v.findParentByTagName(e.startContainer,"table",!0)?0:-1;
},
execCommand:function(e,t){
var n=this.selection.getRange();
if(t=t||v.findParentByTagName(n.startContainer,"table",!0)){
var i=t.nextSibling;
i||(i=v.createElement(this.document,"p",{
innerHTML:s.ie11below?v.fillChar:"<br/>"
}),t.parentNode.insertBefore(i,t)),v.remove(t),n=this.selection.getRange(),3==i.nodeType?n.setStartBefore(i):n.setStart(i,0),
...
t.innerHTML=s.ie11below?v.fillChar:"<br/>",e.insertBefore(t,e.firstChild);
var n=this.selection.getRange();
...
queryCommandState:function(){
var e=this.selection.getRange(),t=v.findParentByTagName(e.startContainer,"table");
return t?0==t.getElementsByTagName("caption").length?-1:1:-1;
},
execCommand:function(){
var e=this.selection.getRange(),t=v.findParentByTagName(e.startContainer,"table");
if(t){
v.remove(t.getElementsByTagName("caption")[0]);
var n=this.selection.getRange();
...
e.mergeRange();
var n=this.selection.getRange();
v.isEmptyBlock(t)?n.setStart(t,0).collapse(!0):n.selectNodeContents(t),n.select();
}
}
...
var m=u.nextSibling;
v.remove(u),m&&s.setStart(m,0).setCursor(!1,!0);
}
...
if(d.getElementsByTagName("td").length)v.inDoc(e,this.document)?u.setStart(e,0).setCursor(!1,!0):a&&v.inDoc(a,this.document)?u.selectNodeContents(a).setCursor(!1,!0):r&&v.inDoc(r,this.document)&&u.selectNodeContents(r).setCursor(!0,!0);else{
var f=d.nextSibling;
v.remove(d),f&&u.setStart(f,0).setCursor(!1,!0);
}
}
...
var r=v.getElementsByTagName(i,"td th");
c.each(r,function(e){
e.removeAttribute("width");
...
function t(e){
c.each(v.getElementsByTagName(i.table,"th"),function(e){
e.setAttribute("width","");
});
var t=i.isFullRow()?v.getElementsByTagName(i.table,"td"):i.selectedTds;
c.each(t,function(t){
...
execCommand:function(){
function e(){
var e,t,o=0,r=i.table,l=a(n,r),d=parseInt(v.getComputedStyle(r.getElementsByTagName("td")[0],"padding-top"));
if(i.isFullCol()){
var c,u,f=v.getElementsByTagName(r,"caption"),m=v.getElementsByTagName(r,"th");
f.length>0&&(c=f[0].offsetHeight),m.length>0&&(u=m[0].offsetHeight),o=r.offsetHeight-(c||0)-(u||0),
t=0==m.length?i.rowsNum:i.rowsNum-1;
}else{
for(var h=i.cellsRange.beginRowIndex,p=i.cellsRange.endRowIndex,g=0,b=v.getElementsByTagName(r,"tr"),y=h;p>=y;y++)o+=b[y].offsetHeight,
g+=1;
t=g;
}
...
function t(e){
var t=i.isFullCol()?v.getElementsByTagName(i.table,"td"):i.selectedTds;
c.each(t,function(t){
...
var o=n.selection.getStart(),a=o&&v.findParentByTagName(o,["td","th","caption"],!0);
/caption/gi.test(a.tagName)?(a.style.textAlign=t.align,a.style.verticalAlign=t.vAlign):v.setAttributes(a,t),
...
execCommand:function(e,t){
var n=this,i=n.selection.getStart(),o=i&&v.findParentByTagName(i,["table"],!0);
...
execCommand:function(e,t){
var n=this.selection.getRange(),i=v.findParentByTagName(n.startContainer,"table");
if(i){
var o=v.getElementsByTagName(i,"td").concat(v.getElementsByTagName(i,"th"),v.getElementsByTagName(i,"caption"));
c.each(o,function(e){
...
var t;
return(t=v.findParentByTagName(e,"td",!0)||v.findParentByTagName(e,"th",!0))?t:null;
}
function o(e){
var t=new RegExp(v.fillChar,"g");
if(e[s.ie?"innerText":"textContent"].replace(/^\s*$/,"").replace(t,"").length>0)return 0;
...
Y=!1,J=0,S(t))),st&&ft)return J=0,W.body.style.webkitUserSelect="none",W.selection.getNative()[s.ie9below?"empty":"removeAllRanges"](),
n=r(t),g(W,!0,st,n,o),void("h"==st?ut.style.left=h(ft,t)+"px":"v"==st&&(ut.style.top=p(ft,t)+"px"));
if(o){
if(W.fireEvent("excludetable",o)===!0)return;
n=r(t);
var a=b(o,n),l=v.findParentByTagName(o,"table",!0);
if(m(l,o,t,!0)){
...
var o=v.getXY(e),r=e.ownerDocument;
...
v.unSelectable(dt),dt.onmouseover=function(){
ct=!0;
},dt.onmouseout=function(){
ct=!1;
},v.on(dt,"click",function(e,t){
n(t,this);
}),v.on(dt,"dblclick",function(e,t){
i(t);
}),v.on(dt,"dragstart",function(e,t){
v.preventDefault(t);
});
var a;
...
return"v1"==a&&o.y-v.getXY(e).y-l<8;
}
return"h1"==a&&o.x-v.getXY(e).x<8;
}
function h(e,t){
var n=tt(e);
if(n){
var i=n.getSameEndPosCells(e,"x")[0],o=n.getSameStartPosXCells(e)[0],a=r(t).x,s=(i?v.getXY(i).x:v.getXY(n.table).x)+20,l=o?v.getXY(o).x+o.offsetWidth-20:W.body.offsetWidth+5||parseInt(v.getComputedStyle(W.body,"width"),10);
return s+=X,l-=X,s>a?s:a>l?l:a;
}
}
function p(t,n){
try{
var i=v.getXY(t).y,o=r(n).y;
return i>o?i:o;
}catch(a){
e(a);
}
...
try{
t.body.style.cursor="h"==i?"col-resize":"v"==i?"row-resize":"text",s.ie&&(!i||mt||nt(t)?H(t):(U(t,t.document),
$(i,r))),lt=n;
}catch(a){
e(a);
}
...
},0)):(ot(v.getElementsByTagName(W.body,"th td")),n.clearSelected());
}
}else N(t);
}
function C(e){
...
var n;
if(n=b(t,r(e))){
if(H(W),"h1"==n)if(n="h",m(v.findParentByTagName(t,"table"),t,e))W.execCommand("adaptbywindow");else if(t=tt(t).getPreviewCell(t)){
...
function N(e){
if(ot(v.getElementsByTagName(W.body,"td th")),c.each(W.document.getElementsByTagName("table"),function(e){
e.ueTable=null;
}),rt=F(W,e)){
var t=v.findParentByTagName(rt,"table",!0),n=tt(t);
...
if(2!=t.button){
var n=this,i=n.selection.getRange(),o=v.findParentByTagName(i.startContainer,"table",!0),r=v.findParentByTagName(i.endContainer,"table",!0);
if((o||r)&&(o===r?(o=v.findParentByTagName(i.startContainer,["td","th","caption"],!0),
r=v.findParentByTagName(i.endContainer,["td","th","caption"],!0),o!==r&&n.selection.clearRange()):n.selection.clearRange()),
mt=!1,n.document.body.style.webkitUserSelect="",st&&ft){
n.selection.getNative()[s.ie9below?"empty":"removeAllRanges"](),J=0,ut=n.document.getElementById("ue_tableDragLine");
var l=v.getXY(ft),d=v.getXY(ut);
switch(st){
case"h":
I(ft,d.x-l.x);
break;
...
if(u)i=new a.Range(n.document),v.isEmptyBlock(u)?i.setStart(u,0).setCursor(!1,!0):i.selectNodeContents(u).shrinkBoundary().setCursor(!1,!0);else if(i=n.selection.getRange().shrinkBoundary(),
!i.collapsed){
var o=v.findParentByTagName(i.startContainer,["td","th"],!0),r=v.findParentByTagName(i.endContainer,["td","th"],!0);
(o&&!r||!o&&r||o&&r&&o!==r)&&i.setCursor(!1,!0);
}
rt=null,n.removeListener("mouseover",B);
}else{
var f=v.findParentByTagName(t.target||t.srcElement,"td",!0);
if(f||(f=v.findParentByTagName(t.target||t.srcElement,"th",!0)),f&&("TD"==f.tagName||"TH"==f.tagName)){
...
if(at=v.findParentByTagName(i,"td",!0)||v.findParentByTagName(i,"th",!0),rt&&at&&("TD"==rt.tagName&&"TD"==at.tagName||"TH"==rt.tagName&&"TH"==at.tagName)&&v.findParentByTagName(rt,"table")==v.findParentByTagName(at,"table")){
var o=tt(at);
if(rt!=at){
...
function _(e,t,n){
var i=parseInt(v.getComputedStyle(e,"line-height"),10),o=n+t;
...
function A(e,t,n){
if(t||(t=v.findParentByTagName(e,"table")),!t)return null;
for(var i=(v.getNodeIndex(e),e),o=t.rows,r=0;i;)1===i.nodeType&&(r+=i.colSpan||1),
i=i.previousSibling;
i=null;
var a=[];
...
function M(e){
if(tab=v.findParentByTagName(e,"table",!1),void 0===tab.offsetVal){
var t=e.previousSibling;
...
function U(e){
mt||(ut=e.document.createElement("div"),v.setAttributes(ut,{
id:"ue_tableDragLine",
unselectable:"on",
contenteditable:!1,
...
function H(e){
if(!mt)for(var t;t=e.document.getElementById("ue_tableDragLine");)v.remove(t);
}
function $(e,t){
if(t){
var n,i=v.findParentByTagName(t,"table"),o=i.getElementsByTagName("caption"),r=i.offsetWidth,a=i.offsetHeight-(o.length>0?o[0].offsetHeight:0),s=v.getXY(i),l=v.getXY(t);
switch(e){
case"h":
...
function q(e,t){
for(var n,i,o=v.getElementsByTagName(e.body,"table"),r=0;i=o[r++];){
var a=v.getElementsByTagName(i,"td");
a[0]&&(t?(n=a[0].style.borderColor.replace(/\s/g,""),/(#ffffff)|(rgb\(255,f55,255\))/gi.test(n)&&v.addClass(i,"noBorderTable")):v.removeClasses(i,"noBorderTable"));
}
}
function V(e,t,n){
var i=e.body;
...
v.preventDefault(i));
var d=v.findParentByTagName(a.selection.getStart(),"caption",!0),c=a.selection.getRange();
if(c.collapsed&&d&&o(d)){
a.fireEvent("saveScene");
var u=d.parentNode;
v.remove(d),u&&c.setStart(u.rows[0].cells[0],0).setCursor(!1,!0),a.fireEvent("saveScene");
}
}
if(46==s){
var l=nt(a);
if(l){
a.fireEvent("saveScene");
for(var f,m=0;f=l.selectedTds[m++];)v.fillNode(a.document,f);
a.fireEvent("saveScene"),v.preventDefault(i);
}
}
if(13==s){
var h=a.selection.getRange(),d=v.findParentByTagName(h.startContainer,"caption",!0);
if(d){
var u=v.findParentByTagName(d,"table");
return h.collapsed?d&&h.setStart(u.rows[0].cells[0],0).setCursor(!1,!0):(h.deleteContents(),
a.fireEvent("saveScene")),void v.preventDefault(i);
}
if(h.collapsed){
var u=v.findParentByTagName(h.startContainer,"table");
if(u){
var p=u.rows[0].cells[0],g=v.findParentByTagName(a.selection.getStart(),["td","th"],!0),b=u.previousSibling;
if(p===g&&(!b||1==b.nodeType&&"TABLE"==b.tagName)&&v.isStartInblock(h)){
var y=v.findParent(a.selection.getStart(),function(e){
return v.isBlockElm(e);
},!0);
...
g(this,!1,"",null),dt&&v.remove(dt);
}),W.addListener("beforepaste",function(i,a){
var l=this,d=l.selection.getRange();
if(v.findParentByTagName(d.startContainer,"caption",!0)){
...
var m,h,d=l.selection.getRange(),p=v.findParentByTagName(d.startContainer,["td","th"],!0);
if(p){
var g=tt(p);
if(r){
var b=g.getCellInfo(p).rowIndex;
"TH"==p.tagName&&b++;
for(var y,C=0;y=e[C++];){
for(var N,x=g.insertRow(b++,"td"),w=0;N=y[w];w++){
var E=x.cells[w];
...
l.__hasEnterExecCommand=!1,p=g.table.rows[0].cells[k.cellIndex],"TH"==p.tagName&&(p=g.table.rows[1].cells[k.cellIndex]);
}
for(var y,C=0;y=e[C++];){
m=p;
...
var S=N.cloneNode(!0);
v.removeAttributes(S,["class","rowSpan","colSpan"]),h.parentNode.appendChild(S);
}
...
for(var y,C=0;y=e[C++];){
for(var N,x=f.insertRow(f.rows.length),w=0;N=y[w++];)S=et.cloneCell(N,null,!0),v.removeAttributes(S,["class"]),
x.appendChild(S);
2==w&&S.rowSpan>1&&(S.rowSpan=1);
}
var B=it(l),_=l.body.offsetWidth-(ht?2*parseInt(v.getComputedStyle(l.body,"margin-left"),10):0)-2*B.tableBorder-(l.options.offsetWidth||0);
...
u.innerHTML=a.html,I=u.getElementsByTagName("table"),v.findParentByTagName(l.selection.getStart(),"table")?(c.each(I,function(e){
v.remove(e);
}),v.findParentByTagName(l.selection.getStart(),"caption",!0)&&(u.innerHTML=u[s.ie?"innerText":"textContent"])):c.each(I,function(e){
t(e,!0),v.removeAttributes(e,["style","border"]),c.each(v.getElementsByTagName(e,"td"),function(e){
o(e)&&v.fillNode(l.document,e),t(e,!0);
});
}),a.html=u.innerHTML;
}),W.addListener("afterpaste",function(){
c.each(v.getElementsByTagName(W.body,"table"),function(e){
if(e.offsetWidth>W.body.offsetWidth){
var t=it(W,e);
e.style.width=W.body.offsetWidth-(ht?2*parseInt(v.getComputedStyle(W.body,"margin-left"),10):0)-2*t.tableBorder-(W.options.offsetWidth||0)+"px";
}
});
...
var e=W.selection.getRange(),t=v.findParentByTagName(e.startContainer,["th","td"],!0);
if(t){
...
n=v.findParentByTagName(n,["td","th"],!0),c.each(v.getElementsByTagName(e.document,"table"),function(t){
e.fireEvent("excludetable",t)!==!0&&(t.ueTable=new et(t),c.each(v.getElementsByTagName(e.document,"td"),function(t){
v.isEmptyBlock(t)&&t!==n&&(v.fillNode(e.document,t),s.ie&&6==s.version&&(t.innerHTML="&nbsp;"));
}),c.each(v.getElementsByTagName(e.document,"th"),function(t){
v.isEmptyBlock(t)&&t!==n&&(v.fillNode(e.document,t),s.ie&&6==s.version&&(t.innerHTML="&nbsp;"));
...
}),v.on(W.document,"mousemove",l),v.on(W.document,"mouseout",function(e){
...
if(t)for(var n=this,i=t.rows,o=n.options.classList,r=i.length,a=0;r>a;a++)v.removeClasses(i[a],o);
}),W.addListener("mousedown",y),W.addListener("mouseup",k),v.on(W.body,"dragstart",function(e){
...
var e=this.selection.getRange(),t=e.getCommonAncestor(!0,!0),n=v.findParentByTagName(t,"table");
if(n){
if(v.findParentByTagName(t,"caption",!0)){
var i=v.getElementsByTagName(n,"th td");
i&&i.length&&e.setStart(i[0],0).setCursor(!1,!0);
}else{
var i=v.findParentByTagName(t,["td","th"],!0),r=tt(i);
...
if(!t){
var n=this.body.offsetWidth/document.body.offsetWidth,i=v.getElementsByTagName(this.body,"table");
c.each(i,function(e){
if(e.offsetWidth<W.body.offsetWidth)return!1;
var t=v.getElementsByTagName(e,"td"),i=[];
c.each(t,function(e){
i.push(e.offsetWidth);
});
for(var o,r=0;o=t[r];r++)o.setAttribute("width",Math.floor(i[r]*n));
e.setAttribute("width",Math.floor(V(W,ht,it(W))));
});
}
});
var h=W.execCommand;
...
for(var d,c,u,f=-2,m=-2,p=0;u=n[p];p++)o(u)?s.setStart(u,0).setCursor(!1,!0):s.selectNode(u).select(!0),
...
v.isEmptyBlock(u)&&v.fillNode(t.document,u));
...
}),"contextmenu"==t&&(v.preventDefault(i),s.ie9below)){
var d;
try{
...
return v.filterNodeList(e.selection.getStartElementPath(),t);
},n=this;
n.addshortcutkey({
Bold:"ctrl+66",
Italic:"ctrl+73",
...
o.insertNode(a).removeInlineStyle(i),o.setStartBefore(a),v.remove(a);
}else{
...
n.__hasEnterExecCommand=!1,c=n.selection.getRange(),i.length&&l(c),m&&c.setStartBefore(m).collapse(!0),
c.select(),m&&v.remove(m);
}
...
var a=r.startContainer;
i=v.findParents(a,!0,function(e){
return!v.isBlockElm(e)&&1==e.nodeType;
});
...
execCommand:function(e,t){
var n,i,o=this,r=t.tag,a=v.findParent(o.selection.getStart(),function(e){
...
v.moveChild(a,d),a.parentNode.insertBefore(d,a),v.remove(a);
}else v.remove(a,!0);else{
var c=v.getCommonAncestor(i.start,i.end),u=v.getElementsByTagName(c,r);
new RegExp(r,"i").test(c.tagName)&&u.push(c);
for(var m,h=0;m=u[h++];)if(m.getAttribute("label")==t.label){
var p=v.getPosition(m,i.start),g=v.getPosition(m,i.end);
if((p&v.POSITION_FOLLOWING||p&v.POSITION_CONTAINS)&&(g&v.POSITION_PRECEDING||g&v.POSITION_CONTAINS)&&f.$block[r]){
var d=o.document.createElement("p");
v.moveChild(m,d),m.parentNode.insertBefore(d,m);
}
v.remove(m,!0);
}
a=v.findParent(c,function(e){
...
n.collapse(),a=v.findParent(o.selection.getStart(),function(e){
return e.getAttribute("label")==t.label;
},!0);
var b=o.document.createElement("p");
v.insertAfter(a,b),v.fillNode(o.document,b),n.setStart(b,0).setCursor();
}
}else{
if(n=o.selection.getRange(),n.collapsed)return a=o.document.createElement(r),v.setAttributes(a,s),
...
if(o.collapsed){
var r=v.findParent(e.selection.getStart(),function(e){
return e.getAttribute("label");
},!0);
if(r&&f.$block[r.tagName]&&v.isEmptyNode(r)){
var a=e.document.createElement("p");
v.insertAfter(r,a),v.fillNode(e.document,a),v.remove(r),o.setStart(a,0).setCursor();
}
}
}
});
...
execCommand:function(e,t){
for(var n,i=this,o=i.selection.getRange(),r=o.startContainer;r&&!v.isBody(r);)n=r,
r=r.parentNode;
if(n){
var a=i.document.createElement("p");
t?n.parentNode.insertBefore(a,n):n.parentNode.insertBefore(a,n.nextSibling),v.fillNode(i.document,a),
...
render:function(e){
for(var n,i=this.renderHtml(),o=t.createElementByHtml(i),r=v.getElementsByTagName(o,"*"),a="edui-"+(this.theme||this.editor.options.theme),s=document.getElementById("edui_fixedlayer"),l=0;n=r[l++];)v.addClass(n,a);
v.addClass(o,a),s&&(s.className="",v.addClass(s,a));
var d=this.getDom();
null!=d?(d.parentNode.replaceChild(o,d),t.copyAttributes(o,d)):("string"==typeof e&&(e=document.getElementById(e)),
e=e||t.getFixedLayer(),v.addClass(e,a),e.appendChild(o)),this.postRender();
},
getDom:function(e){
...
function e(e){
for(var t,n=e.editor.options.autotypeset,i=e.getDom(),o=e.editor.uid,r=null,a=null,s=v.getElementsByTagName(i,"input"),l=s.length-1;t=s[l--];)if(r=t.getAttribute("type"),
...
for(var m,h=v.getElementsByTagName(i,"select"),l=0;m=h[l++];){
...
_onClick:function(e){
var t=v.getNextDomNode(e),i=n.getViewportRect().height,o=n.getClientRect(t);
t.style.top=o.top+o.height>i?-o.height-e.offsetHeight+"px":"",/hidden/gi.test(v.getComputedStyle(t,"visibility"))?(t.style.visibility="visible",
v.addClass(e,"edui-state-opened")):(t.style.visibility="hidden",v.removeClasses(e,"edui-state-opened"));
},
_UIBase_render:i.prototype.render
...
this.editor.fireEvent("reportAddNum",65080,8,1),this.editor.fireEvent("reportAddNum",65080,l[i],1),
...
a=-1==s?l.other:l[o+"px"],this.editor.fireEvent("reportAddNum",65080,8,1),this.editor.fireEvent("reportAddNum",65080,a,1),
...
_scale:function(){
function e(){
p=a.getXY(l),g||(g=r.options.minFrameHeight+c.offsetHeight+u.offsetHeight),m.style.cssText="position:absolute;left:0;display:;top:0;background-color:#41ABFF;opacity:0.4;filter: Alpha(opacity=40);width:"+l.offsetWidth+"px;height:"+l.offsetHeight+"px;z-index:"+(r.options.zIndex+1),
...
function n(){
h&&(h=!1,r.ui._actualFrameWidth=m.offsetWidth-2,l.style.width=r.ui._actualFrameWidth+"px",
r.setHeight(m.offsetHeight-u.offsetHeight-c.offsetHeight-2)),m&&(m.style.display="none"),
i(),a.un(o,"mousemove",t),a.un(d,"mouseup",n),a.un(o,"mouseup",n);
}
function i(){
s.ie?o.selection.clear():window.getSelection().removeAllRanges();
}
var o=document,r=this.editor,l=r.container,d=r.document,c=this.getDom("toolbarbox"),u=this.getDom("bottombar"),f=this.getDom("scale"),m=this.getDom("scalelayer"),h=!1,p=null,g=0,v=r.options.minFrameWidth,b=0,y=0,C=0,N=0;
this.enableScale=function(){
f&&1!=r.queryCommandState("source")&&(f.style.display="",this.scaleEnabled=!0,a.on(f,"mousedown",e));
},this.disableScale=function(){
f&&(f.style.display="none",this.scaleEnabled=!1,a.un(f,"mousedown",e));
};
},
