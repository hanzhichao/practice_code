...
$.fn.zclip_new||($.fn.zclip_new=$.fn.zclip=function(n){
return this.each(function(){
var o=jQuery(this),c=this,t=new ZeroClipboard(o);
t.on("ready",function(){
t.on("copy",function(){
var o="";
n.copy&&(o=n.copy.call(c)||""),t.setText(o);
}),t.on("aftercopy",function(){
n.afterCopy&&n.afterCopy.call(c);
});
});
});
});
